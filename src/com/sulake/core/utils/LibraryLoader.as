package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1452:uint = 2;
      
      protected static const const_1453:uint = 1;
      ...
      protected var var_304:int;
      
      protected var var_2424:String = "";
      
      protected var var_153:int = 0;
      
      protected var var_533:XML;
      
      protected var var_1199:Boolean = true;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_533 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      {
         return !!var_587 ? uint(var_195 - var_838) : uint(getTimer() - var_838);
      }
