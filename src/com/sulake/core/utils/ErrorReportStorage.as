package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1346:Map = new Map();
      
      private static var var_918:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         var _loc1_:String = "";
         var _loc2_:int = 0;
         while(_loc2_ < var_918.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_918.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_918.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         return var_1346[param1];
      }
      
      public static function addDebugData(param1:String, param2:String) : void
      {
         var_918.remove(param1);
         var_918.add(param1,param2);
      }
