package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_640:uint = 0;
      
      public static const const_617:String = "AssetLibraryReady";
      
      public static const const_1258:String = "AssetLibraryUnloaded";
      
      public static const const_505:String = "AssetLibraryLoaded";
      
      public static const const_1403:String = "AssetLibraryLoadError";
       
      
      private var var_533:XML;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_640;
         var_431 = new Dictionary(false);
         var_432 = new Dictionary(false);
         var_774 = new Dictionary(false);
         var_139 = new Dictionary(false);
         var_1122.push(this);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_431)
         {
            _loc4_ = AssetTypeDeclaration(var_431[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_774)
         {
            delete var_774[_loc1_];
         }
         if(var_17 != null)
         {
            var_17.dispose();
         ...
         var_325 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1258));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_533 = _loc2_.manifest.copy();
         var_380 = _loc2_.resource;
         _file = _loc2_.url;
         if(var_534)
         {
            AssetLibrary.fetchLibraryContents(this,var_533,var_380);
         }
         var_325 = true;
         dispatchEvent(new Event(AssetLibrary.const_505));
         dispatchEvent(new Event(AssetLibrary.const_617));
         if(var_534)
         {
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_432[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_41,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_937,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_989,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_913,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_910,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_432[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_431.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_431[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1122.splice(var_1122.indexOf(this),1);
            --var_640;
            var_432 = null;
            var_774 = null;
            var_139 = null;
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1403));
         var_17 = null;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_431)
         {
            _loc3_ = AssetTypeDeclaration(var_431[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_774[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_533.child("library");
         if(_loc2_ == null)
         {
      ...
      {
         var _loc2_:IAsset = var_139[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_432[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  var_139[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_41,e.status);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_431[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
