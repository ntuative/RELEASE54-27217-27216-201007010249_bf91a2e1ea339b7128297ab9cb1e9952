package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1040:uint = 256;
      
      protected static var var_698:uint = 0;
      
      protected static var var_399:uint = 0;
      
      public static const const_905:uint = 2;
      
      public static const const_1630:uint = 128;
      
      public static const const_1652:uint = 64;
      
      public static const const_764:uint = 4;
      
      public static const const_1436:uint = 0;
      
      public static const const_1301:uint = 16;
      
      public static const const_683:uint = 1;
      
      public static const const_1280:uint = 8;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1280:
               ...
               break;
            case GraphicContext.const_1301:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_764:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1040:
               break;
            case GraphicContext.const_1436:
               break;
            default:
         ...
         if(var_690)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1722,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1722,16777215);
                  }
                  var_399 += bitmap.width * bitmap.height * 4;
               }
