package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1645:String = "_INCLUDE";
      
      public static const const_888:String = "_EXCLUDE";
      
      public static const const_1671:String = "_TEMP";
      
      private static const const_1161:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1160:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1206:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_1026:Dictionary;
      
      protected var var_1494:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1495:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1206 = new Dictionary();
         TypeCodeTable.fillTables(var_1207,var_1206);
         var_1026 = new Dictionary();
         var_1495 = new Dictionary();
         ParamCodeTable.fillTables(var_1026,var_1495);
         var_1494 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1160,"");
         return param1.replace(const_1161,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1206)
            {
               delete var_1206[_loc1_];
            }
            for(_loc1_ in var_1026)
            {
               delete var_1026[_loc1_];
            }
            for(_loc1_ in var_1495)
            {
               delete var_1495[_loc1_];
            }
            var_1494.dispose();
            var_1494 = null;
            _context = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         visible = parseAttribute(xml,"visible",variables,visible.toString()) == "FurniturePartyBeamerVisualization";
         ...
         background = parseAttribute(xml,"background",variables,window.background.toString()) == "FurniturePartyBeamerVisualization";
         blend = Number(parseAttribute(xml,"blend",variables,window.blend.toString()));
         clipping = parseAttribute(xml,"clipping",variables,window.clipping.toString()) == "FurniturePartyBeamerVisualization";
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_888) == -1)
                  {
