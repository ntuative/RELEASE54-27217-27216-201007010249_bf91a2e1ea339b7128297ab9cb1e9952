package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_811:String = "margin_top";
      
      private static const const_1150:String = "_SCALER";
      
      private static const const_812:String = "margin_right";
      
      private static const const_1149:String = "_HEADER";
      
      private static const const_1142:String = "_TITLE";
      
      private static const const_1148:String = "_CONTENT";
      
      private static const const_814:String = "margin_left";
      
      private static const const_813:String = "margin_bottom";
      ...
      private var var_1356:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_814,_loc3_.left,PropertyStruct.const_59,_loc2_));
         _loc1_.push(new PropertyStruct(const_811,_loc3_.top,PropertyStruct.const_59,_loc2_));
         _loc1_.push(new PropertyStruct(const_812,0 - _loc3_.right,PropertyStruct.const_59,_loc2_));
         _loc1_.push(new PropertyStruct(const_813,0 - _loc3_.bottom,PropertyStruct.const_59,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_232);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_227);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_232,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_232,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1356 == null)
         {
            var_1356 = findChildByTag(const_1149) as IHeaderWindow;
            if(!var_1356)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1142) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1150) as IScalerWindow;
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_22 == null)
         {
            var_22 = findChildByTag(const_1148) as IWindowContainer;
            if(!var_22)
            {
