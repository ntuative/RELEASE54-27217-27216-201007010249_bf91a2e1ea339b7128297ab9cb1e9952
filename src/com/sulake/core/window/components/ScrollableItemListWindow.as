package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1009:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_393)
         {
            var_393 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_393)
            {
               var_393.addEventListener(WindowEvent.const_254,scrollBarEventProc);
               var_393.addEventListener(WindowEvent.const_235,scrollBarEventProc);
            }
         }
         return var_393;
      }
      ...
      {
         return _itemList.method_3(param1);
      }
      ...
      override public function dispose() : void
      {
         if(var_393)
         {
            var_393.removeEventListener(WindowEvent.const_254,scrollBarEventProc);
            var_393.removeEventListener(WindowEvent.const_235,scrollBarEventProc);
            var_393 = null;
         }
         if(var_1009)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_1009)
         {
            var_1009 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_1009;
      }
