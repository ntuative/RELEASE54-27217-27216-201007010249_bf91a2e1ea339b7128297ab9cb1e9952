package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1062:String = "resize_on_item_update";
      
      protected static const const_1064:String = "spacing";
      ...
      protected static const const_1063:String = "auto_arrange_items";
      ...
      protected var var_584:Number;
      
      protected var var_194:Boolean = false;
      
      protected var var_93:Number;
      
      protected var var_1484:Boolean = false;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_836:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         _container = _context.create("_CONTAINER","",WindowType.const_304,WindowStyle.const_324,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.TAG_INTERNAL,WindowController.TAG_EXCLUDE]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_253,containerEventHandler);
         _container.addEventListener(WindowEvent.const_412,containerEventHandler);
         resizeOnItemUpdate = var_1198;
      }
      ...
      {
         return new Rectangle(var_586 * maxScrollH,var_584 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_253,containerEventHandler);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1064,_spacing,PropertyStruct.const_59,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1063,var_836,PropertyStruct.const_55,var_836 != const_1449));
         _loc1_.push(new PropertyStruct(const_1065,var_585,PropertyStruct.const_55,var_585 != const_1448));
         _loc1_.push(new PropertyStruct(const_1062,var_1198,PropertyStruct.const_55,var_1198 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_584 = param1;
            _container.y = -var_584 * maxScrollV;
            _context.invalidate(_container,visibleRegion,WindowRedrawFlag.const_75);
         }
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1062:
                  ...
                  break;
               case const_1063:
                  var_836 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      public function method_3(param1:int) : IWindow
      {
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_461,param1);
            }
            else
            {
