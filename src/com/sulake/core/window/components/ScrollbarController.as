package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1116:String = "increment";
      
      private static const const_516:String = "slider_bar";
      
      private static const const_1115:String = "decrement";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param2.type == WindowNotifyEvent.const_484)
         {
            if(var_23 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(const_781) as WindowController;
      }
      ...
      {
         return track.findChildByName(const_516) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_888 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_888 != null)
         {
            _loc1_ = findParentByName(var_888) as IScrollableWindow;
            if(_loc1_ == null && var_12 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_12).findChildByName(var_888) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_49)
         {
            ...
            else if(param2.name == const_1115)
            {
               if(var_23)
               {
                  var_619 = true;
         ...
         if(param1.type == WindowMouseEvent.const_992)
         {
