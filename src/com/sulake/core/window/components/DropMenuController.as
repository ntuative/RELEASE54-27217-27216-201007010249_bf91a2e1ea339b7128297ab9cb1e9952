package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private var var_130:DropMenuController;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(var_130 == null || false)
         {
            var_130 = context.create(name + "::submenu","",WindowType.const_480,var_83,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            var_130.setGlobalRectangle(_loc1_);
         }
         var_130.activate();
         return var_130;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_898)
         {
            if(param2 == var_130)
            {
               closeMenuView();
      ...
      protected function method_11(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         var _loc6_:* = null;
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_476,var_83,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         if(var_508 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_508).setStateFlag(WindowState.WINDOW_STATE_SELECTED,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_614)
         {
            if(open())
            {
               if(false)
               {
                  method_11(var_507,getSubMenu(),subMenuEventProc);
                  var_614 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_508 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_319,this,null));
         }
      }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            if(var_130 != null)
            {
               _loc2_ = var_130.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_614 = false;
            getTitleText().text = var_508 < var_507.length && var_508 > -1 ? "null" : caption;
         }
      }
   }
}
