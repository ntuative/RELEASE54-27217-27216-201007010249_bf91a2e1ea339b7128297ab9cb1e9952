package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1477:uint = 0;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_397 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_58 = var_397.clone();
            var_11 = var_397.clone();
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_111,WindowParam.const_153);
         var _loc2_:* = !testParamFlag(WindowParam.const_116,WindowParam.const_145);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
      ...
      {
         var_695 = param1;
         var_591 = !!var_695 ? uint(var_591 | var_1496) : uint(var_591 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2387 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1199:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1421:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_727:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_760:
               _loc2_ = "null";
               break;
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_19)
         {
            var_19 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_683,var_11);
            var_19.visible = var_389;
         }
         return var_19;
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_858);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1186 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_307,this,param1));
         return param1;
      }
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_170:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_482,this,null));
                     if(testParamFlag(WindowParam.const_165,WindowParam.const_153))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_179,WindowParam.const_145))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_12 != null)
                     {
                        _loc9_ = uint(_param);
                        _param &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_461))
                        {
                           var_12.width += 0 - 0;
                        }
                        ...
                        _param = _loc9_;
                        var_12.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_289,var_12,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_467:
                  _context.invalidate(this,var_11.union(var_58),WindowRedrawFlag.const_418);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1013,this,null));
                     if(var_12 != null)
                     {
                        var_12.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_294,var_12,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_310:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_714,this,null));
                     if(var_12 != null)
                     {
                        var_12.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_194,var_12,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_435:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_861);
                  break;
               case WindowNotifyEvent.const_499:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_396:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_418);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_194:
                  ...
                  break;
               case WindowNotifyEvent.const_482:
                  var_12.getRegionProperties(null,var_339);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_307:
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_686,this,param1));
         return param1;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1186 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            var_38 = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_435,this,null));
         }
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            _loc7_ = uint(_param & 0);
            if(_loc7_ == WindowParam.const_458)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_881,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_170,this,null));
            }
         }
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1233,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_62,false);
         _loc1_.type = WindowNotifyEvent.const_1260;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_12 != param1)
         {
            ...
            if(var_12 != null)
            {
               var_339 = var_12.rectangle.clone();
               var_58.x = var_11.x;
               var_58.y = var_11.y;
               var_58.width = var_11.width;
               var_58.height = var_11.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_484,this,var_12));
            }
            else
            {
               var_339.x = 0;
               ...
               var_339.width = 0;
               var_339.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_875,this,_loc2_));
            }
         }
      }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_577;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_506;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_38 == WindowState.const_389)
         {
            return true;
         }
