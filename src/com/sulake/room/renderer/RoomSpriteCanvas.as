package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1481:int = 50;
      ...
      private var var_248:BitmapDataCache;
      ...
      private var var_2164:Number = -1.0E7;
      
      private var var_2504:int = 0;
      
      private var var_542:RoomObjectCache;
      
      private var var_782:int;
      
      private var var_287:Sprite;
      
      private var var_1137:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_248 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         if(_container != null)
         {
            _loc6_ = "null";
         ...
         var_328 = new Map();
         var_542 = new RoomObjectCache(_loc6_);
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc5_ = var_248.getBitmapData(_loc4_);
            if(!param3)
            {
               return _loc5_;
            }
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_248.addBitmapData(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
      ...
      {
         var_542.removeObjectCache(param1);
      }
      ...
      public function update() : void
      {
         if(var_939 == 0)
         {
            checkMouseHits(var_1136.x,var_1136.y,MouseEvent.MOUSE_MOVE);
         }
         var_939 = 0;
         ++var_724;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_287 != null)
         {
            var_287.graphics.clear();
         }
         else
         {
            var_287 = new Sprite();
            var_287.name = "mask";
            _master.addChild(var_287);
         }
         var_287.graphics.beginFill(0);
         var_287.graphics.drawRect(0,0,param1,param2);
         var_782 = param1;
         var_781 = param2;
         var_57.graphics.clear();
         var_57.graphics.beginFill(var_2504);
      ...
      {
         var _loc11_:Number = param1 - var_782 / 2;
         var _loc12_:Number = param2 - var_781 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_782 != var_2165 || var_781 != var_2161)
         {
            _loc9_ = true;
         }
         _loc4_ = 0;
         ...
         var_442.sortOn("z",0 | 0);
         if(_loc5_ < var_442.length)
         {
            var_442.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = var_442[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
      ...
      public function dispose() : void
      {
         ...
         if(var_541 != null)
         {
            ...
            {
               cleanSprite(var_541[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_541 = [];
         }
         ...
         while(_loc1_ < var_328.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1137 != null)
                  {
                     var_1137.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_724,geometry);
                  }
                  else
                  {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc6_ = var_248.getBitmapData(_loc5_);
            if(!param4)
            {
               return _loc6_;
            }
         ...
         if(_loc6_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_248.addBitmapData(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var_1136.x = param1;
         var_1136.y = param2;
         if(var_939 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return var_1638;
         }
         var_1638 = checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++var_939;
         return var_1638;
      }
      ...
      {
         if(param1 < 0 || param1 >= var_442.length)
         {
            return null;
         }
         return var_442[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_543.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_543.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2162 || param2 != var_2164)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_543.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_543.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_541.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = var_248.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     var_248.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_542.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_542.getObjectCache(param2);
         ...
         _loc13_ += int(var_782 / 2);
         _loc14_ += int(var_781 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_782 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_781))
                  {
