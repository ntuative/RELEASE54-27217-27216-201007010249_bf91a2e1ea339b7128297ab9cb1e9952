package com.sulake.room.object
{
   ...
   public class RoomObjectModel implements IRoomObjectModelController
   {
      ...
      public function setNumber(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         if(var_537[param1] != param2)
         {
            var_537[param1] = param2;
            ++_updateID;
         }
      }
      ...
      public function setStringArray(param1:String, param2:Array, param3:Boolean = false) : void
      {
         ...
         var _loc6_:Array = var_535[param1];
      ...
      public function setString(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_538[param1] != param2)
         {
            var_538[param1] = param2;
            ++_updateID;
         }
      }
      ...
      public function setNumberArray(param1:String, param2:Array, param3:Boolean = false) : void
      {
         ...
         var _loc6_:Array = var_536[param1];
         var _loc7_:Boolean = true;
         if(_loc6_ != null && _loc6_.length == _loc4_.length)
         {
            _loc5_ = _loc4_.length - 1;
      ...
      {
         var _loc2_:Array = var_536[param1];
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.slice();
         }
      ...
      public function dispose() : void
      {
         ...
         if(var_536 != null)
         {
            for(_loc1_ in var_536)
            {
               delete var_536[_loc1_];
            }
            var_536 = null;
         }
         if(var_535 != null)
         {
            for(_loc1_ in var_535)
            {
               delete var_535[_loc1_];
            }
            var_535 = null;
         }
         var_1128 = [];
      ...
      {
         var _loc2_:Array = var_535[param1];
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.slice();
         }
