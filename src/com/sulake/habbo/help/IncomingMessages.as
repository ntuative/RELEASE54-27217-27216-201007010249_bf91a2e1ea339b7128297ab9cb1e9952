package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_25.tellUI(HabboHelpViewEnum.const_221,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_25.tellUI(HabboHelpViewEnum.const_285,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_25.tellUI(HabboHelpViewEnum.const_148);
      }
      ...
      {
         var_25.showUI(HabboHelpViewEnum.const_348);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_25.showUI(HabboHelpViewEnum.const_457);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_25.showUI(HabboHelpViewEnum.const_556);
         var_25.tellUI(HabboHelpViewEnum.const_556,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         {
            _loc5_ = _loc3_.method_6(_loc4_);
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_314)
            {
         ...
         var_25.tellUI(HabboHelpViewEnum.const_680);
      }
