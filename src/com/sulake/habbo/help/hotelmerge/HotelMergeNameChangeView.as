package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      public function setNameAvailableView() : void
      {
         ...
         _controller.localization.registerParameter("help.tutorial.name.available","name",var_392);
      ...
      private function showSelectionView() : void
      {
         if(!var_684)
         {
            var_684 = createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!var_684)
            {
               return;
            }
            _window.content.addChild(var_684);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!var_267)
         {
            var_267 = createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!var_267)
            {
               return;
            }
            _window.content.addChild(var_267);
         }
         _window.caption = _controller.localization.getKey("hotel_merge.name_change.title.confirm");
         var _loc1_:ITextWindow = var_267.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = var_392;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "confirm_name_button":
               _controller.changeName(var_392);
               break;
      ...
      public function showMainView() : void
      {
         if(!_window)
         {
            ...
            var_1462 = _window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_859 = new NameSuggestionListRenderer(_controller);
