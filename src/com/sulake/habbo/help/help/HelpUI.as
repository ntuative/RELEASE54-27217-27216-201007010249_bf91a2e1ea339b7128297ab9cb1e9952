package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1482:int = 0;
      ...
      private var var_2232:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","27217-27216-201007010239");
         _toolbar = param5;
         var_114 = new Map();
         var_114.add(HabboHelpViewEnum.const_1192,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_148,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_457,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_285,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_221,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_556,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_348,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_574,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_243,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_114.add(HabboHelpViewEnum.const_834,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_680,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_294 == HabboHelpViewEnum.const_148 || false)
         {
            return;
         }
         if(var_450 == null)
         {
            ...
            var_450 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_450 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_450 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_450 as IWindow);
      ...
      {
         return var_114.getValue(var_294);
      }
      ...
      {
         var_2234 = param1;
         var _loc2_:IHelpViewController = var_114.getValue(HabboHelpViewEnum.const_148) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_243:
               showUI(HabboHelpViewEnum.const_243);
               break;
            case CallForHelpResultEnum.const_894:
      ...
      {
         var _loc3_:* = null;
         if(var_294 == HabboHelpViewEnum.const_148)
         {
            return;
         }
         if(true)
         ...
         var _loc2_:IBitmapWrapperWindow = var_450.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1651;
         _window.width = _loc1_.width + var_1652;
      }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_25.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_390));
      }
