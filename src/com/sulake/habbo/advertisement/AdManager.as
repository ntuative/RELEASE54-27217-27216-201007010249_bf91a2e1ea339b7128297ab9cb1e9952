package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_945:BitmapData = null;
      ...
      private var var_944:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_377,0,0,_loc4_,var_1645,var_944,var_945));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2187 = _config.getKey("interstitial.enabled","HabboRoomWidgetLib_room_queue") == "FurniturePartyBeamerVisualization";
         var_2185 = int(_config.getKey("interstitial.interval","30000"));
         var_2186 = int(_config.getKey("interstitial.show.time","5000"));
         var_1643 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1377 = _loc2_.imageUrl;
         var_1645 = _loc2_.clickUrl;
         if(var_1377 != "" && var_1645 != "")
         {
            _loc3_ = var_1377;
            ...
            _loc4_ = new URLRequest(var_1377);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1378 = _loc2_.imageUrl;
         var_2188 = _loc2_.clickUrl;
         var_787 = getTimer();
         if(var_1378 != "")
         {
            _loc3_ = var_1378;
            ...
            if(var_251 == null)
            {
               var_251 = new Timer(var_2186,1);
               var_251.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_251.reset();
            ...
            var_251.start();
            _loc4_ = new URLRequest(var_1378);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
            _loc5_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,interstitialLoaderEventHandler);
            _loc5_.addEventListener(AssetLoaderEvent.const_41,interstitialLoaderEventHandler);
         }
         else
         {
            stopInterstitial();
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_442,0,0,param1.bitmapData,var_2188));
            var_787 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_945 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1643 > 0 && var_1644 >= var_1643)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_787;
         if(_loc1_ > var_2185)
         {
            ++var_1644;
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_376));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_944 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
