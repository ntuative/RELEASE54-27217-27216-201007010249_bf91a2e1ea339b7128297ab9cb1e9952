package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1082:ICheckBoxWindow;
      ...
      private var var_1083:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_687,_data.flatId),var_54,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_742.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1209,_loc2_,var_407.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1082.isSelected,var_1083.isSelected,var_742.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1293);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1205);
      }
      ...
      public function populate() : void
      {
         ...
         var_742 = ICheckBoxWindow(var_54.findChildByName("kick_check"));
         var_1082 = ICheckBoxWindow(var_54.findChildByName("lock_check"));
         var_1083 = ICheckBoxWindow(var_54.findChildByName("changename_check"));
