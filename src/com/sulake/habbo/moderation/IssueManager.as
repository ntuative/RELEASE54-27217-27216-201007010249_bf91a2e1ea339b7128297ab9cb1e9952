package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_997:String = "issue_bundle_open";
      
      public static const const_650:String = "issue_bundle_my";
      
      public static const const_960:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_127 = new Map();
         var_857 = new Map();
         var_604 = new IssueBrowser(this,var_63.windowManager,var_63.assets);
         var_707 = [];
         var_856 = [];
         var_1046 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1046.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:IssueBundle = var_127.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
         sendPick(_loc2_.getIssueIds());
         var_707 = var_707.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_857.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = var_127.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     var_127.remove(_loc3_.id);
                     removeHandler(_loc3_.id);
                  }
                  var_857.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1406)
         {
            var_163.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_127)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_857.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_857.add(param1.issueId,_loc2_);
            var_127.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(var_707.indexOf(param1.issueId) != -1)
         {
            handleBundle(_loc3_.id);
         }
         if(param1.state == IssueMessageData.const_144)
         {
            _loc5_ = getBundles(const_650);
            _loc6_ = false;
            ...
            _loc8_ = var_856.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         var_856 = var_856.concat(param1);
      }
      
      public function closeBundle(param1:int, param2:int) : void
      {
         var _loc3_:IssueBundle = var_127.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:* = var_1046.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoPick() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = var_127.getValues();
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_604 == null || !var_604.isOpen())
         {
            var_63.soundManager.playSound(HabboSoundTypesEnum.const_1041);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_857.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_127.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = var_127.getValues();
         var _loc4_:int = var_63.sessionDataManager.userId;
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.state == IssueMessageData.const_440 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
