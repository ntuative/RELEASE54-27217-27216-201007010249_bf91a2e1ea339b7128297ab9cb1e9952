package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1662:IMessageComposer;
      ...
      {
         var_852 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_851 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         _main.connection.send(var_1662);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_852.clone());
      ...
      {
         if(param1.type != WindowEvent.const_42 || param2 != var_54)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_851.clone());
