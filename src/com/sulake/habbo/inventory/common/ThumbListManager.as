package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1049:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_607 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_607.width;
         var_97 = var_607.height;
         var_1048 = param5;
         var_863 = param6;
         var_226 = Math.floor(var_1048 / _thumbWidth);
         var_20 = new BitmapData(var_1048,var_863);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_20.height < var_863)
         {
            _loc12_ = new BitmapData(var_20.width,var_863);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_607.width,var_607.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_607.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_607,var_607.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1049 != null)
         {
            _loc1_ = var_1049.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_496 = resolveRowCountFromList();
         if(var_496 == 0)
         {
            var_20 = new BitmapData(var_1048,var_863);
            return;
         }
         var_20 = new BitmapData(Math.max(var_226 * _thumbWidth,var_1048),Math.max(var_496 * var_97,var_863),true,16777215);
         var_20.fillRect(var_20.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_496)
         {
            _loc4_ = 0;
