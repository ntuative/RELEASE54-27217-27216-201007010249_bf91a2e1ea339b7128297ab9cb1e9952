package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      private var var_336:PetsGridItem;
      ...
      private var var_539:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_539 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_666 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_666.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_336 != null)
         {
            var_336.setSelected(false);
         }
         var_336 = param1;
         if(var_336 != null)
         {
            var_336.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_336.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_666.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_539.removeGridItem(_loc2_.window);
         if(var_336 == _loc2_)
         {
            var_336 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_666.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_539.addGridItem(_loc2_.window);
            var_666.add(param1.id,_loc2_);
            if(var_336 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_47,this);
            if(_loc13_ == null)
            {
               return;
            }
