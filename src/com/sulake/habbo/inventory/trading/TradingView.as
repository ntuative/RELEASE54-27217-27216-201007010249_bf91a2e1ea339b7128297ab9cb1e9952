package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_783:uint = 2577770;
      
      public static const const_1047:int = 0;
      ...
      private var var_1571:IWindowContainer;
      
      private var var_181:Timer;
      
      private var var_371:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_371 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1000)
            {
            ...
            var_371.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_414);
            var_371.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_181)
            {
               var_181.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_181.stop();
               var_181 = null;
            }
            if(var_371 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1571 == null)
         {
            var_1571 = createMinimizedWindow();
         }
         if(!var_1953)
         {
            return var_66;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_181 == null)
         {
            var_181 = new Timer(1000,3);
            var_181.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_181.reset();
         var_181.repeatCount = 3;
         var_181.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_66)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_782) : uint(const_783);
            }
         ...
         if(var_66)
         {
            ...
            switch(var_24.state)
            {
               ...
               case TradingModel.const_274:
                  ...
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_504:
                  _loc1_.disable();
                  showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_191:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
