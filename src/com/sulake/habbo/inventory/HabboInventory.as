package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_914:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_21 != null)
         {
            var_21.events.removeEventListener(RoomSessionEvent.const_89,roomSessionEventHandler);
            var_21.events.removeEventListener(RoomSessionEvent.const_108,roomSessionEventHandler);
            var_21.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_413,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_108:
               var_914 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_413:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_49.getValue(InventoryCategory.const_614));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_49.getValue(InventoryCategory.const_76));
      }
      ...
      {
         return PetsModel(var_49.getValue(InventoryCategory.const_142));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_933));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1740);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_49.getValue(InventoryCategory.const_344));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_258:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_913.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_913.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_49.getValue(InventorySubCategory.const_258));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_361 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_913.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_49.getValue(InventoryCategory.const_317) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1110 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_49.getValue(InventoryCategory.const_263));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_21.events.addEventListener(RoomSessionEvent.const_89,roomSessionEventHandler);
         var_21.events.addEventListener(RoomSessionEvent.const_108,roomSessionEventHandler);
         var_21.events.addEventListener(RoomSessionPropertyUpdateEvent.const_413,roomSessionEventHandler);
         ...
         var_49.add(InventoryCategory.const_317,_loc3_);
         ...
         var_49.add(InventoryCategory.const_76,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_361);
         var_49.add(InventoryCategory.const_263,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_49.add(InventoryCategory.const_614,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_361);
         var_49.add(InventoryCategory.const_344,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_49.add(InventorySubCategory.const_258,_loc8_);
         ...
         var_49.add(InventoryCategory.const_142,_loc10_);
