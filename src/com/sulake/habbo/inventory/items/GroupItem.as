package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1728:int = 13421772;
      ...
      protected var var_1031:Boolean;
      ...
      private const const_1727:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_398:BitmapData;
      
      private const const_1493:Number = 0.2;
      
      protected var var_1497:Boolean;
      
      private const const_1494:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_623)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1517));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1493);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _window.blend = const_1494;
               _loc1_.blend = const_1494;
            }
         }
         if(isSelected)
         {
