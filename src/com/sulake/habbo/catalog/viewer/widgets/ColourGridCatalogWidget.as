   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function populateColourGrid() : void
      {
         ...
         for each(_loc1_ in var_1263)
         {
            ...
            _loc2_.width = var_711.width;
            _loc2_.height = var_711.height;
            _colourGrid.addGridItem(_loc2_);
            _loc3_ = _loc2_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_711.width,var_711.height,true,0);
               _loc3_.bitmap.copyPixels(var_711,var_711.rect,new Point(0,0));
            }
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_759.width,var_759.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_759,var_759.rect,new Point(0,0),null,null,true);
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         var_711 = _loc2_.content as BitmapData;
         ...
         var_759 = _loc4_.content as BitmapData;
         populateColourGrid();
