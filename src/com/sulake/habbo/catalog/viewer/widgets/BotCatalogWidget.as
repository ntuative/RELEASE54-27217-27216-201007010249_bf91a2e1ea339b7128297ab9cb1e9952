package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      protected var var_1029:IItemGridWindow;
      ...
      {
         super(param1);
         var_1029 = _window.findChildByName("botGrid") as IItemGridWindow;
         var_1658 = new Map();
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc2_:int = var_1658.getValue(param1);
         if(true)
         {
            return;
         }
         for each(_loc3_ in page.offers)
         {
            ...
            {
               _loc4_ = var_1399.getValue(_loc3_.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1398) as IWindowContainer;
         var_1029.addGridItem(_loc2_);
         ...
         if(_loc5_)
         {
            ...
            _loc4_.invalidate();
            var_1658.add(_loc3_,param1.offerId);
            _loc5_.dispose();
         }
      }
      ...
      {
         var _loc1_:String = var_1399.getValue(var_798.productContainer.firstProduct.extraParam.toLowerCase());
         var _loc2_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createAvatarImage(_loc1_,AvatarScaleType.const_47);
         if(_loc2_)
         {
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_798,page);
      }
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","credits",String(var_798.priceInCredits));
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","pixels",String(var_798.priceInPixels));
            _loc2_.text = "${catalog.purchase.price.credits+pixels}";
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(var_798.localizationId);
