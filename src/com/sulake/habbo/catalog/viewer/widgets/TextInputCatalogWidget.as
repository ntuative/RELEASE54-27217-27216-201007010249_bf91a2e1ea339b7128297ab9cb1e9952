package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1160 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1160 != null)
         {
            var_1160.addEventListener(WindowKeyboardEvent.const_711,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1160.text));
      }
   }
}
