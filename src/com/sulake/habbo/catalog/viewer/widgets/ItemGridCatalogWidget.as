package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected var var_336:IGridItem;
      
      protected var var_131:Boolean = true;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_679,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.const_254,activateScrollbar);
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_986 >= 0 && var_986 < page.offers.length)
            {
               _loc4_ = page.offers[var_986];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         {
            ++var_1686;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1686);
         }
      }
      
      override public function init() : void
      {
         var_1029 = _window.findChildByName("itemGrid") as IItemGridWindow;
