package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_676[var_1170] as Array;
      ...
      {
         var _loc2_:Offer = var_676[var_1170][var_2339];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_441 || _loc1_.pricingModel == Offer.const_456)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_80 || _loc3_.productType == ProductTypeEnum.const_81)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1171.indexOf(_loc5_) == -1)
                        {
                           var_1171.push(_loc5_);
                           var_676.push(new Array());
                        }
                        _loc6_ = var_1171.indexOf(_loc5_);
                        (var_676[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in var_676)
         {
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_676)
         {
            if(var_2339 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2339] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1170 = var_1029.getGridItemIndex(param1.view);
