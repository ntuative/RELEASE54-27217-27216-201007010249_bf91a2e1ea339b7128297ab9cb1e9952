package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1657:Point;
      
      private var var_2239:Array;
      
      private var var_660:IItemGridWindow;
      
      private var var_90:IBitmapWrapperWindow;
      
      private var var_1475:ITextWindow;
      
      private var var_1394:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_660 != null)
         {
            var_660.visible = false;
            var_660.destroyGridItems();
         }
         if(var_1394 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1475.text = "${" + _loc3_.name + "}";
            var_1474.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1475.text = "${" + _loc2_.localizationId + "}";
            var_1474.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_424:
                  _loc4_ = var_1395.clone();
                  if(var_660 != null)
                  {
                     var_660.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_660,var_1394,var_1398);
                  }
                  break;
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_211:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           _loc13_ = _loc12_.avatarRenderManager.createAvatarImage(_loc14_,AvatarScaleType.const_47);
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_40,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_277,AvatarAction.const_380);
                              _loc13_.appendAction(AvatarAction.const_411,_loc6_.productClassId);
      ...
      {
         var_1475 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1474 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_90 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1657 = new Point(var_90.x,var_90.y);
         var_660 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1394 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_660 == null)
         {
         ...
         var_1395 = _loc2_.content as BitmapData;
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(var_90 != null && true)
         {
            ...
            var_90.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            var_90.invalidate();
            var_90.x = var_1657.x;
            var_90.y = var_1657.y;
            if(param3 != null)
