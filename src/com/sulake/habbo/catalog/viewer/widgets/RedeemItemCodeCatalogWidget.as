package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1090 != null)
         {
            var_1090.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1091 != null)
         {
            var_1091.removeEventListener(WindowKeyboardEvent.const_141,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1090 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1090 != null)
         {
            var_1090.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1091 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1091 != null)
         {
            var_1091.addEventListener(WindowKeyboardEvent.const_141,windowKeyEventProcessor);
         }
      }
