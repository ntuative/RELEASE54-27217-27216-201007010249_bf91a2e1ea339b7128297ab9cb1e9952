package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_931:MarketPlaceOfferData;
      ...
      private const const_1477:int = 2;
      ...
      private function updateList() : void
      {
         ...
         if(!var_540)
         {
            ...
            var_540 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_540)
         {
            return;
         ...
         updateStatusDisplay(const_1477,_loc2_.length);
         if(!var_439)
         {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_646)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_540 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_540.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1478);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_932 >= var_646.length)
            {
               return true;
            }
            addListItem(var_646.getWithIndex(var_932));
            ++var_932;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_931.offerId);
            }
            return;
         }
