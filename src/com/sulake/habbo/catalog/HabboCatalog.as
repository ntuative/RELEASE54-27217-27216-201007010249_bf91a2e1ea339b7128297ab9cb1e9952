package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_448:ClubBuyController;
      ...
      private var var_123:IMarketPlace;
      ...
      private var var_334:CatalogViewer;
      
      private var var_2229:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_449:ICatalogNavigator;
      ...
      private var var_2230:GiftWrappingConfiguration;
      ...
      {
         return var_361.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2231 && var_549 != null)
         {
            var_549.playSound(HabboSoundTypesEnum.const_940);
         }
         var_2231 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_361.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_80)
         {
            _loc3_ = var_361.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_448 == null)
         {
            var_448 = new ClubBuyController(this);
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               var_1393 = param1.session.isPrivateRoom;
               if(var_89 != null)
               {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "FurniturePartyBeamerVisualization" == var_150.getKey("client.credits.embed.enabled"))
            {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2230 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!var_959)
         {
            if(!var_361.loadProductData(this))
            {
               return;
            }
            init();
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_449 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function method_14(param1:IMessageEvent) : void
      {
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         {
            var_448.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_123.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function createMarketPlace() : void
      {
         if(var_123 == null)
         {
            var_123 = new MarketPlaceLogic(this,_windowManager,_roomEngine);
         }
      }
      ...
      {
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _communication.addHabboConnectionMessageEvent(new NotEnoughBalanceMessageEvent(method_14));
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_449.buildCatalogIndex(_loc2_);
         if(var_1146 != "")
         {
            var_449.openPage(var_1146);
            var_1146 = "";
         }
         else
         {
            var_449.openFrontPage();
         }
      }
      ...
      {
         if(param1 == null || var_334 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_334.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         var_89.storePrizeTable(_loc2_.method_16);
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_334.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2229 && var_549 != null)
         {
            var_549.playSound(HabboSoundTypesEnum.const_977);
         }
         var_2229 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_334.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_334.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_334 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_334.habboCatalog = this;
      }
