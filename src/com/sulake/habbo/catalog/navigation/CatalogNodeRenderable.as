package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1123:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1596:XML;
      
      private static var var_1597:XML;
       
      
      private var var_2459:IWindowContainer;
      ...
      private var var_1595:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1595 == 4294967295)
            {
               var_1595 = _loc1_.color;
            }
            _loc1_.color = const_1123;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1420;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1596) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_52 = navigator.catalog.windowManager.buildFromXML(var_1597) as IItemListWindow;
         if(var_52 == null)
         {
