package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2502:String = "magic.pixels";
      
      private var var_2501:String = "catalog.page.club";
      
      private var var_2518:String = "magic.credits";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","HabboRoomWidgetLib_room_queue") == "FurniturePartyBeamerVisualization";
         if(false && _loc1_)
         {
      ...
      {
         _catalog.openCatalogPage(var_2501,true);
      }
