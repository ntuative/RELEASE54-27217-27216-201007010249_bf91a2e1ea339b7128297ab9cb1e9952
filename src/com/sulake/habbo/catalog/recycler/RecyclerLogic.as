package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1579)
         {
            case RecyclerStatusMessageEvent.const_1435:
               var_277 = const_365;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_943:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1252:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1579 != RecyclerStatusMessageEvent.const_943;
      }
      
      private function get statusActive() : Boolean
      {
         return var_277 != const_787;
      }
      ...
      {
         return active && var_277 == const_365;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_891:
               if(_view != null)
               {
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!_catalog.returnInventoryFurniFromRecycler(var_103[param1].id))
         {
            return;
         }
         var_103[param1] = null;
