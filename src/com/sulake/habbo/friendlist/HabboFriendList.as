package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1570:OpenedToWebPopup;
      
      private var var_890:IAvatarRenderManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_469:FriendListTabs;
      ...
      private var var_1569:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_620:ISessionDataManager;
      
      private var var_369:FriendRequests;
      
      private var var_1948:int;
      
      var var_94:FriendCategories;
      
      private var var_1949:FriendListLookAndFeel;
      ...
      {
         var_1949 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_94 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1569 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_369.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_369.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_469.findTab(FriendListTab.const_85).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_369 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_94.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_94.addCategory(new FriendCategory(FriendCategory.const_1039,getText("friendlist.friends")));
         var_94.addCategory(new FriendCategory(FriendCategory.const_492,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_94.addFriend(new Friend(_loc4_));
         }
         var_469 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_516)
         {
            var_516 = new Timer(120000);
            var_516.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_516.start();
         }
         getBuddyRequests();
         registerListeners();
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_516.stop();
            var_516.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_516 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_133)
         {
            var_133.release(new IIDHabboMessenger());
            var_133 = null;
         }
         if(var_150)
         {
         ...
         if(var_890)
         {
            var_890.release(new IIDAvatarRenderManager());
            var_890 = null;
         }
         if(var_891)
         {
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_133 = param2 as IHabboMessenger;
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "FurniturePartyBeamerVisualization";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_469.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1569.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_369.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ > var_369.limit)
         {
            var_369.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_469.findTab(FriendListTab.const_85);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_890.createAvatarImage(param1,AvatarScaleType.SMALL,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_369.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_469.findTab(FriendListTab.const_85);
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1570 == null)
         {
            var_1570 = new OpenedToWebPopup(this);
         }
         var_1570.show(x,y);
      }
