package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1490:String = "no_reqs_info";
       
      
      private var var_1681:IContainerButtonWindow;
      
      private var _friendList:HabboFriendList;
      
      private var var_1682:IContainerButtonWindow;
      ...
      {
         var_1681 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1682 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1682.procedure = onDismissAllButtonClick;
         var_1681.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_312 && _loc4_.state != FriendRequest.const_328)
            {
               ...
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_275,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_842)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1681,_loc1_);
         setEnabled(var_1682,_loc1_);
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_275,param1));
         }
      }
   }
}
