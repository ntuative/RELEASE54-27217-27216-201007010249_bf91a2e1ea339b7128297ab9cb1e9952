package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_1592:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1320));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1592[var_1320]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
