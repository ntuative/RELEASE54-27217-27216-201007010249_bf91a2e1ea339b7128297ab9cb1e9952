package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               ...
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_136,onBadgeImage);
            }
            if(false)
            {
         ...
         if(false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_136,onBadgeImage);
         }
         if(false)
         {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_542);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_354);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_973);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_879);
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_215)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_314)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_996)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_470);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_193)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_242)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_754);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1282;
                  if(!_loc25_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1396);
               }
               else
               {
               ...
               _loc18_ = _loc11_.sex;
               _loc19_ = _container.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_47,_loc18_);
               if(_loc19_ != null)
               {
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         if(false)
         {
            _loc5_ = _container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_47,param1.gender);
            if(_loc5_ != null)
            {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_651.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_47);
            var_651.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_754);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_292);
         _loc1_.push(RoomWidgetFurniActionMessage.const_674);
         _loc1_.push(RoomWidgetFurniActionMessage.const_702);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_698);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_584);
         _loc1_.push(RoomWidgetUserActionMessage.const_373);
         _loc1_.push(RoomWidgetUserActionMessage.const_731);
         _loc1_.push(RoomWidgetUserActionMessage.const_740);
         _loc1_.push(RoomWidgetUserActionMessage.const_1397);
         _loc1_.push(RoomWidgetPetCommandMessage.const_737);
         _loc1_.push(RoomWidgetPetCommandMessage.const_599);
      ...
      public function dispose() : void
      {
         ...
         if(var_651 != null)
         {
            _loc1_ = var_651.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_651.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_373)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_622:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_902,_loc3_.name);
            ...
            case RoomWidgetRoomTagSearchMessage.const_698:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_584:
               ...
               break;
            case RoomWidgetUserActionMessage.const_373:
