package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_629);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_597);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_588);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_629:
            ...
            case RoomWidgetFriendRequestMessage.const_597:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_588:
