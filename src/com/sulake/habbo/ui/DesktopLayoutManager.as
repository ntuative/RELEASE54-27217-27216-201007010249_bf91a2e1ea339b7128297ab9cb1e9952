package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private var var_750:int = 50;
      
      private var var_2458:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_55.getChildByTag(const_1122) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_55.findChildByTag(const_1122) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_750;
               _loc2_.width = var_55.desktop.width - var_750;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_750;
               _loc2_.height = var_55.desktop.height - var_750;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_55.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < var_55.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_253,trimContainer);
            }
            _loc5_++;
         }
      }
