package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_616:
               ...
               break;
            case RoomWidgetWaveMessage.const_602:
               if(_container != null && false)
               {
                  _container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_560:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_669:
               if(var_14 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_572:
               if(var_14 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_762:
               if(var_14 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_720:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_995)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_649:
               ...
               if(var_14 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_949:
                        _catalog.openCatalogPage(CatalogPageName.const_1386,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1054:
                        var_14.toggleInventoryPage(InventoryCategory.const_263);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1348:
                        var_14.toggleInventoryPage(InventoryCategory.const_76);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1430:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_600:
            ...
            case RoomWidgetNavigateToRoomMessage.const_893:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_709:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_682:
               ...
               break;
            case RoomWidgetToolbarMessage.const_611:
               ...
               if(_toolbar && false)
               {
                  _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_419,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_305:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_431));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_681:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_694:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_330,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_677:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_330,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_658:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_448));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_352:
               _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_628));
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_107:
               ...
               break;
            case HabboHelpTutorialEvent.const_493:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_374));
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_706,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_493,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_706,onFigureUpdate);
         ...
         if(var_14 != null)
         {
            (var_14 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_933,onAvatarEffectsChanged);
            (var_14 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1043,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_493,onHelpTutorialEvent);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_602);
         _loc1_.push(RoomWidgetDanceMessage.const_560);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_669);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_572);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_762);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_625);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_649);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_720);
         _loc1_.push(RoomWidgetStopEffectMessage.const_600);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1244);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_893);
         _loc1_.push(RoomWidgetToolbarMessage.const_682);
         _loc1_.push(RoomWidgetToolbarMessage.const_611);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_305);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1419);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_868);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_709);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_616);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_681);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1405);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_694);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_677);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_658);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_352);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_527));
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(false)
         {
            ...
            if(_loc3_ != var_1367)
            {
               ...
               _loc5_ = _container.avatarRenderManager.createAvatarImage(_loc3_,AvatarScaleType.const_47,_loc4_,this);
               if(_loc5_ != null)
               {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1014,HabboToolbarIconEnum.MEMENU);
