package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_551:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_386.length)
            {
               _loc2_ = var_386.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(var_387 != null)
         {
            ...
            {
               _loc2_ = var_387.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = var_387.getValue(_loc15_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = var_386.getValue(_loc15_) as BitmapData;
                           }
                           _loc12_ = uint(var_799.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_215)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       var_387.add(_loc15_,_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    var_386.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_799.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_578,RoomWidgetChatSelectAvatarMessage.const_652];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_578:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_149,_container.roomSession,0,"Version 27217-27216-201007010239");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_652:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_551 == null)
            {
               ...
               var_550.y = 0;
               var_550.z = 0;
               var_551 = _loc4_.getScreenPoint(var_550);
            ...
            var_550.y = 0;
            var_550.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_550);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_551.x || _loc8_.y != var_551.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_551,_loc5_));
