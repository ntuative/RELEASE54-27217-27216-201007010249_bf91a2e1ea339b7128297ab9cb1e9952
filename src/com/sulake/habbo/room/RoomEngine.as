package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_796:int = -2;
      ...
      private static const const_795:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1120:String = "tile_cursor";
      ...
      private var var_747:RoomMessageHandler = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         var_747 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_70 != null)
         {
            ...
            {
               return var_70.deleteWallItem(var_117,var_118,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_315.length; _loc2_++)
         {
            _loc3_ = var_315.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_666) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_530) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_695) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_738) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_70 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return var_70.modifyWallItemData(var_117,var_118,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_405 != null)
         {
            var_405.release(new IIDRoomObjectVisualizationFactory());
            var_405 = null;
         }
         if(var_44 != null)
         {
         ...
         if(var_315 != null)
         {
            ...
            {
               _loc2_ = var_315.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_855;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.method_10 = _loc8_.getNumber(RoomVariableEnum.const_633);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_753);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_541);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_978);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_963);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_872) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_862);
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_619,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_610,var_117,var_118,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_70 != null)
         {
            return var_70.modifyRoomObject(var_117,var_118,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_316.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_316.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_555,param3);
         ...
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_689,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_44 != null)
         {
            ...
            var_44.addObjectUpdateCategory(RoomObjectCategoryEnum.const_257);
            var_44.addObjectUpdateCategory(RoomObjectCategoryEnum.const_61);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_70 != null)
         {
            var_70.handleRoomObjectEvent(param1,var_117,var_118);
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_15.sessionDataManager = var_361;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_354,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_313,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1029,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_973,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_879,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_272,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
      ...
      {
         if(var_29 == null || var_405 == null || var_44 == null || var_746 == null || _communication == null || _habboConfiguration == null || !var_1981)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_298,RoomObjectCategoryEnum.const_61);
      }
      ...
      public function addObjectFurnitureByName(param1:int, param2:int, param3:int, param4:String, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN) : Boolean
      {
         ...
         if(method_1(_loc10_) && var_15 != null)
         {
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1324,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_44.getRoom(getRoomIdentifier(var_117,var_118));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_797,RoomObjectCategoryEnum.const_257);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_117,var_118,var_1314);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_117,var_118,var_1314);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_15 != null)
         {
            var_15.visualizationFactory = var_405;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_29 != null)
         {
            if(false)
            {
               ...
               var_29.events.addEventListener(RoomObjectMouseEvent.const_469,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMouseEvent.const_379,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectStateChangeEvent.const_160,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectStateChangeEvent.const_554,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_133,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_115,roomObjectEventHandler);
               ...
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_117,roomObjectEventHandler);
               ...
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_478,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_502,roomObjectEventHandler);
               ...
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_460,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_475,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_383,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_466,roomObjectEventHandler);
               ...
               var_29.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_56,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMoveEvent.const_393,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMoveEvent.const_427,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_281,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_415,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_318,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_308,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_430,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_922,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_410,roomObjectEventHandler);
               var_29.events.addEventListener(AvatarWalkWarpingWarningEvent.const_401,warningEventHandler);
            }
         }
      }
      ...
      {
         var _loc5_:IRoomInstance = getRoom(var_117,var_118);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_748) != 0)
         {
            return false;
         }
         if(var_70 != null)
         {
            return var_70.initializeRoomObjectInsert(var_117,var_118,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_521 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_644,0,0));
            _loc2_ = 0;
            while(_loc2_ < var_316.length)
            {
               _loc3_ = var_316.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_272,param1,param2,param3,RoomObjectCategoryEnum.const_33));
         }
         return true;
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1035,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_965,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_488);
                     break;
                  case RoomObjectCategoryEnum.const_33:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_157);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_347);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_707)
         {
            var_1981 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_354,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_313,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_855,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_272,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_296.events.addEventListener(AdEvent.const_377,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_795) as Sprite;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_315.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_558,param1,param2));
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_488,param8);
               break;
            case RoomObjectCategoryEnum.const_33:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_157,param2);
               break;
            case RoomObjectCategoryEnum.const_61:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_260,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_665,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_656,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_620,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_477,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1092.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_953,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_796,RoomObjectCategoryEnum.const_257);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_117,var_118,param1);
         if(_loc9_ != null)
         {
            var_1314 = param1;
            var_1581 = param2;
            ...
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_453,var_117,var_118,-1,RoomObjectCategoryEnum.const_202));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_70 != null)
               {
                  ...
                  var_70.handleRoomObjectEvent(_loc14_,var_117,var_118);
               }
            }
         }
      }
      ...
      {
         return method_1(getWorldType(param1,param2));
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_117,var_118,param1,param2,new Vector3d(),1,null);
         }
         else if(var_15 != null)
         {
            _loc8_ = null;
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_117,var_118,var_1314);
         if(_loc7_ != null)
         {
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_15 != null)
         {
            ...
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_332,param1.image,true);
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_998,param1.adWarningL,true);
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_843,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_961,RoomObjectVariableEnum.const_332,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_315.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_315.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_15 != null)
         {
            _events.addEventListener(RoomContentLoader.const_707,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_70 != null)
         {
            var_70.cancelRoomObjectInsert(var_117,var_118);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_953);
               ...
               _loc13_ = var_1092.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_117,var_118,const_298,RoomObjectCategoryEnum.const_61,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(method_1(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_986,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_748,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_864,_loc13_,true);
            if(var_15 != null)
            {
         ...
         else
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_748,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_633,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_666,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_695,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_530,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_738,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_967,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_555,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
         ...
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_689,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_477,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_207);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           ...
                           _loc7_.setNumber(RoomObjectVariableEnum.const_541,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_753,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_541,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_978,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_963,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_796,const_1120,RoomObjectCategoryEnum.const_257);
         _loc7_.createRoomObject(const_797,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_257);
         return _loc7_;
      }
