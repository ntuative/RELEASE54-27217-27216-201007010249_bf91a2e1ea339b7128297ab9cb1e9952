package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_771:String = "tile_cursor";
      
      private static const const_296:String = "RCL_PUBLICROOM_";
      
      private static const const_511:String = "wall_place_holder";
      
      private static const name_2:int = 2;
      
      private static const const_360:String = "place_holder";
      
      private static const const_1069:String = const_360;
      ...
      public static const const_707:String = "RCL_LOADER_READY";
      ...
      private var var_1032:IEventDispatcher = null;
      
      private var var_1212:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_488 = [];
         _wallItems = [];
         var_1728 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1732 = ["room_public","room_public_park","room_public_pool"];
         super();
         _libraries = new Map();
         _events = new Map();
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_140 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = var_361.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         if(var_174 != null && var_174.hasWorldType(const_296 + param1))
         {
            return var_174.type;
         }
         return param1;
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_593.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_360,const_511,ROOM_CONTENT,const_771,const_770];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1728.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_174 && _loc5_ != RoomObjectLogicEnum.const_140)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(var_594.getValue(param1) != null)
         {
            return var_594.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1198);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_485.getValue(param1) as String;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_257;
         }
         return RoomObjectCategoryEnum.const_202;
      }
      ...
      private function continueInitilization() : void
      {
         if(var_1731)
         {
            ...
            if(var_1032 != null)
            {
               var_1032.dispatchEvent(new Event(const_707));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_174 != null)
         {
            return var_174.getWorldHeightScale(const_296 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         var_1032 = param1;
         var_1734 = param2.getKey("flash.dynamic.download.url","furniture/");
         var_1730 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         var_1733 = param2.getKey("public.room.dynamic.download.url","");
         var_1729 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         var_38 = const_772;
         initFurniData();
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_174 && _loc5_ != RoomObjectVisualizationEnum.const_140)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_405.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_296 + param1) == RoomObjectCategoryEnum.const_61)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1212.getValue(param1) != null)
         {
            var_174 = var_1212.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_505,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_174 != null)
         {
            return var_174.getWorldScale(const_296 + param1);
         }
         return 32;
      }
   }
