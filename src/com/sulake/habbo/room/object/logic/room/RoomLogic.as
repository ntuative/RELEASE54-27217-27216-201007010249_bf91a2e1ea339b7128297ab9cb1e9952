package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1617:int = 1500;
      
      private var var_1618:int = 255;
      
      private var var_1619:int = 255;
      
      private var var_1353:uint = 16777215;
      
      private var var_1121:uint = 16777215;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_980,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_627,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_749,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_724,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_678,1);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_975,int(param1.bgOnly));
         var_1353 = _color;
         var_1618 = var_1396;
         var_1121 = _loc3_;
         var_1619 = _loc4_;
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_965:
               param2.setNumber(RoomObjectVariableEnum.const_749,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1035:
               param2.setNumber(RoomObjectVariableEnum.const_724,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_678,_loc3_);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_477:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_207)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_619:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_931,_loc7_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_555:
               param2.setString(RoomObjectVariableEnum.const_665,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_734:
               param2.setString(RoomObjectVariableEnum.const_656,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_689:
               param2.setString(RoomObjectVariableEnum.const_620,param1.value);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_926)
         {
            ...
            {
               _loc7_ = var_1353 >> 16 & 255;
               _loc8_ = var_1353 >> 8 & 255;
               _loc9_ = var_1353 & 255;
               _loc10_ = var_1121 >> 16 & 255;
               _loc11_ = var_1121 >> 8 & 255;
               _loc12_ = var_1121 & 255;
               _loc13_ = (_loc2_ - var_926) / var_1617;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1618 + (var_1619 - var_1618) * _loc13_;
               _color = _loc3_;
               var_1396 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_627,_loc3_);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1332,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1309,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1444,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_143 || _loc13_ == RoomPlaneData.const_260)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
