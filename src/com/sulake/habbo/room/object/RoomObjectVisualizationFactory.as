package com.sulake.habbo.room.object
{
   ...
   public class RoomObjectVisualizationFactory extends Component implements IRoomObjectVisualizationFactory
   {
      ...
      private var var_974:IAvatarRenderManager = null;
      
      private var var_2278:Boolean = true;
      ...
      override public function dispose() : void
      {
         ...
         if(var_556 != null)
         {
            ...
            {
               _loc1_ = var_556.getWithIndex(_loc2_) as IRoomObjectVisualizationData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      private function avatarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_974 = param2 as IAvatarRenderManager;
      }
      ...
      public function createRoomObjectVisualization(param1:String) : IRoomObjectGraphicVisualization
      {
         ...
         switch(param1)
         {
            ...
            case RoomObjectVisualizationEnum.const_887:
               ...
               break;
            case RoomObjectVisualizationEnum.const_140:
            ...
            case RoomObjectVisualizationEnum.const_959:
               ...
               break;
            case RoomObjectVisualizationEnum.const_885:
            ...
            case RoomObjectVisualizationEnum.const_985:
               ...
               break;
            case RoomObjectVisualizationEnum.const_1434:
      ...
      public function getRoomObjectVisualizationData(param1:String, param2:String, param3:XML) : IRoomObjectVisualizationData
      {
         ...
         var _loc8_:* = null;
         var _loc4_:* = null;
         _loc4_ = var_556.getValue(param1) as IRoomObjectVisualizationData;
         if(_loc4_ != null)
         {
            return _loc4_;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc6_ is AvatarVisualizationData)
            {
               ...
               _loc7_.avatarRenderer = var_974;
            }
            else if(_loc6_ is PetVisualizationData)
            {
               _loc8_ = _loc4_ as PetVisualizationData;
               _loc8_.avatarRenderer = var_974;
            }
            if(var_2278)
            {
               var_556.add(param1,_loc6_);
            }
            return _loc6_;
         }
         return null;
