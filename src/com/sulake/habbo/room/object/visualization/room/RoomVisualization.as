package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1355:int = 13421772;
      
      private static const const_803:int = 16777215;
      
      public static const const_1402:int = 10066329;
      
      private static const const_804:int = 13421772;
      
      public static const const_1357:int = 16777215;
      
      public static const const_1200:int = 16777215;
      
      private static const const_805:int = 10066329;
      
      private static const const_806:int = 10066329;
      ...
      private var var_1116:uint = 16777215;
      ...
      private var var_635:Rectangle = null;
      ...
      private var var_2088:String = null;
      
      private const const_1742:int = 250;
      ...
      private function getLandscapeHeight() : Number
      {
         ...
         while(_loc2_ < var_88.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_260)
            {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_980);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_967);
         var _loc7_:int = 0;
         while(_loc7_ < var_88.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_156)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1357;
               }
               else
               {
                  _loc13_.color = const_1355;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_260)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1242)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_104,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_931);
            if(_loc3_ != var_2088)
            {
            ...
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_627));
            if(_loc4_ != var_1116)
            {
               var_1116 = _loc4_;
               var_2091 = var_1116 & 255;
               var_2092 = var_1116 >> 8 & 255;
               var_2094 = var_1116 >> 16 & 255;
               _loc2_ = true;
            }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_635 == null)
         {
            var_635 = super.boundingRectangle;
         }
         return new Rectangle(var_635.x,var_635.y,var_635.width,var_635.height);
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_104 || _loc3_.type == RoomPlane.const_84 && _loc12_ == RoomPlaneBitmapMaskData.const_207)
                              {
      ...
      {
         if(param1 != var_322["null"] || param2 != var_322["null"] || param3 != var_322["null"])
         {
            var_322["null"] = param1;
            var_322["null"] = param2;
            var_322["null"] = param3;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(_loc7_ < var_1952 + const_1742 && !_loc4_ && !_loc6_)
         {
            return;
         }
         ...
         var _loc8_:int = 0;
         while(_loc8_ < var_208.length)
         {
            _loc9_ = 0;
            _loc10_ = getSprite(_loc9_);
            _loc11_ = var_208[_loc8_] as RoomPlane;
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_84)
            {
               if(var_1615)
               {
                  ...
                  _loc15_ = uint((_loc12_ >> 16 & 255) * var_2094 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != var_1370)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != var_1135 || _loc3_.y != var_2090 || _loc3_.z != var_2093 || param1.scale != var_2089))
            {
               var_1135 = _loc3_.x;
               var_2090 = _loc3_.y;
               var_2093 = _loc3_.z;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : void
      {
         ...
         if(var_170 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_656);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_665);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_620);
            updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_749));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_724));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_678));
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + var_1600;
      }
