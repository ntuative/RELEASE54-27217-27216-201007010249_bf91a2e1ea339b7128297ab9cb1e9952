package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1170:String = "shore";
      ...
      private function method_7() : void
      {
         ...
         var _loc3_:int = var_554 + 2;
         var _loc4_:int = var_662 + 2;
         var _loc5_:int = 0;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               var_553[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function resetBorders() : void
      {
         ...
         if(var_554 == 0 || var_662 == 0)
         {
            ...
            var_554 = _loc2_.getNumber(RoomObjectVariableEnum.const_284);
            var_662 = _loc2_.getNumber(RoomObjectVariableEnum.const_320);
         }
         var_388 = [];
         var_553 = [];
         var _loc1_:int = 0;
         while(_loc1_ < var_554 * 2 + var_662 * 2)
         {
            var_388.push(false);
            var_553.push(ShoreMaskCreatorUtility.const_66);
            _loc1_++;
         }
      }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               var_553[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc1_:int = var_554 + 2;
         var _loc2_:int = var_662 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      {
         if(var_2245 == param1 && var_2244 == _direction)
         {
            return var_1663;
         }
         var_2245 = param1;
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(_loc2_,_direction,param1) == const_1170)
            {
               var_1663 = _loc2_;
               break;
            }
      ...
      {
         if(var_61 == null || var_61.width < param1 || var_61.height < param2)
         {
            if(var_61 != null)
            {
               var_61.dispose();
            }
            var_61 = ShoreMaskCreatorUtility.createEmptyMask(param1,param2);
         }
         return ShoreMaskCreatorUtility.createShoreMask2x2(var_61,getSize(param3),var_388,var_553,assetCollection);
      }
