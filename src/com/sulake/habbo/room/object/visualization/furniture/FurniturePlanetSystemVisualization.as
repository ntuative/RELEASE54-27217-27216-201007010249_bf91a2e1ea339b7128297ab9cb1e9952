package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_841);
      ...
      {
         if(param1 < var_648.length)
         {
            return var_648[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_246 != null)
         {
            ...
            {
               _loc2_ = var_246[_loc3_];
               _loc2_.update(var_648,var_2143,param1);
               _loc3_++;
            }
