package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_809:int = 15;
      
      private static const const_1139:int = 2;
      
      private static const const_368:int = 2;
      
      private static const const_808:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1117[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1119[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1117 = new Array();
         var_1117.push(Math.random() * _loc2_ * 1.5);
         var_1117.push(Math.random() * _loc2_ * 1.5);
         var_1118 = new Array();
         var_1118.push(1);
         var_1118.push(-1);
         var_1120 = new Array();
         var_1120.push(const_1139);
         var_1120.push(const_1140);
         var_1119 = new Array();
         var_1119.push(getRandomAmplitudeFactor());
         var_1119.push(getRandomAmplitudeFactor());
      }
