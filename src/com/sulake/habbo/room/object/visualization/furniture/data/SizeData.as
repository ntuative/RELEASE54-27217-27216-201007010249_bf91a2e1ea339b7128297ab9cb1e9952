package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1372:int = 360;
      
      private var var_2172:int = 0;
      
      private var var_783:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1372 / 2) % 360 / var_1372;
         ...
         {
            _loc6_ = int(var_249.getKey(_loc5_)) * var_1372;
         ...
         },_loc5_++)
         {
            ...
            switch(String(_loc4_))
            {
               case "ADD":
                  ...
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_1046);
                  break;
               case "DARKEN":
