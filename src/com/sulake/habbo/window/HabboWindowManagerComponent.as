package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_370:uint = 3;
      ...
      private var var_1424:ProfilerAgentTask;
      
      private var var_1425:IEventDispatcher;
      
      private var var_2539:uint = 0;
      
      private var var_1423:ProfilerAgentTask;
      
      private var var_1426:ProfilerOutput;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1425 = Component(param1).events;
         var_459 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_762 = new SkinContainer(_loc3_.content as XML,assets);
         var_817 = new WindowRenderer(var_762);
         var_256 = new Array(const_370);
         var _loc5_:int = 0;
         while(_loc5_ < const_370)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_817,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_256[_loc5_] = _loc4_;
            _loc5_++;
         }
         var_235 = var_256[const_1179];
         ...
         var_235.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1291,_loc6_);
      }
      ...
      {
         return var_256[param1].getDesktopWindow().getChildAt(var_235.getDesktopWindow().numChildren - 1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_459[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_459[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1426 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1426 = new ProfilerOutput(_loc3_,this,var_817);
               var_1424 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1424);
               var_1423 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1423);
               var_1161 = true;
            }
         }
      }
      ...
      {
         return var_762.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1425.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_370 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1425.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_370)
         {
         ...
         var_1425.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1264,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1304,new Date().getTime().toString());
