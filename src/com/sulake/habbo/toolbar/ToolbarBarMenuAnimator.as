package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1085:Number = 90;
      
      private static const const_780:int = 50;
      
      private static const const_1086:Number = 25;
      ...
      private var var_1068:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1068 = param2;
         var_616 = new Timer(const_1086);
         var_616.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function getWindowByName(param1:String) : IWindow
      {
         ...
         if(_loc2_ == null)
         {
            ...
            if(_loc3_ != null)
            {
               _loc2_ = _loc3_.method_15(param1);
            }
         }
         return _loc2_;
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(_loc3_ > -1)
         {
            ...
            var_512.splice(_loc3_,1);
         }
         var_512.push(param1.name);
         var_511.push(param2);
         param1.addEventListener(WindowEvent.const_386,windowEventListener);
         param1.addEventListener(WindowEvent.const_235,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_511[var_512.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1068.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_311.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_311.splice(var_311.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1068.getIconLoc(param1.iconId);
      ...
      {
         return var_512[var_511.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_311[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_615[_loc3_] = new Array();
            }
            if(var_615[_loc3_].indexOf(param1) < 0)
            {
               var_615[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_780 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_780 || param1.desktop.height - param1.y < const_1108;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_512[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_615[_loc3_].length)
                  {
                     repositionWindow(var_615[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
