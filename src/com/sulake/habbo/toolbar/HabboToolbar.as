package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_320.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_134,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1014,onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_419,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_571,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1036,onHideWindowEvent);
         var_38 = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_83));
      }
