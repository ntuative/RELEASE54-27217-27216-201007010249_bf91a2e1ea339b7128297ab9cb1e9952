package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1492:int = 5;
      
      private static const const_522:int = 16;
      
      private static const const_1182:int = 20;
      
      private static const const_369:int = 10;
      
      private static const const_1181:int = 40;
      ...
      private var var_436:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1169 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2338 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2337 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_820 = new Timer(1000,1);
         var_820.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_991 = new Timer(5000,1);
         var_991.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_141,windowKeyEventProcessor);
         ...
         _window.addEventListener(WindowEvent.const_386,onWindowMoved);
         var_1438 = true;
         var_147 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2336 = _loc2_.width + const_522 + _loc6_.width + const_1182;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1181,_loc8_.width) + const_522);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1169 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_147 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_436);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_436);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_563);
