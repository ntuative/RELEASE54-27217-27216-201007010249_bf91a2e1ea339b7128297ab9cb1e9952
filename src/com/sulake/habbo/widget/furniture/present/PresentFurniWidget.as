package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_481,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_384,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_481,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_384,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_63:
               ...
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_384:
               if(!var_232)
               {
                  return;
               }
               ...
               var_204 = param1.text;
               showInterface();
               method_2("packagecard_icon_floor");
               break;
            case RoomWidgetPresentDataUpdateEvent.const_445:
               ...
               var_204 = param1.text;
               showInterface();
               method_2("packagecard_icon_landscape");
               break;
            case RoomWidgetPresentDataUpdateEvent.const_438:
               ...
               var_204 = param1.text;
               showInterface();
               method_2("packagecard_icon_wallpaper");
               break;
            case RoomWidgetPresentDataUpdateEvent.const_481:
               if(!var_232)
               {
                  return;
               }
      ...
      {
         var _loc1_:* = null;
         if(var_232 || var_161 == -1 || !_controller)
         {
            return;
         }
         var_232 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_657,var_161);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_52,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1071,const_1070,2,2),null,0) as IWindowContainer;
