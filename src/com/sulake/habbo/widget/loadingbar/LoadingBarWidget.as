package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_425:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_425 = new Sprite();
            var_425.addChild(new Bitmap(_image));
            var_425.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_425.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_425);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1594 != "")
         {
            HabboWebTools.openWebPage(var_1594);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_425 != null)
         {
            var_425.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_425 = null;
         }
         if(_image != null)
         {
