package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1754:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1439 != null && var_1439.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_992 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_992 += param1.height + const_1754;
            return fit(param1);
         }
         param1.offset(_offsetX,var_992);
         _offsetX += param1.width + const_1755;
         return true;
      }
