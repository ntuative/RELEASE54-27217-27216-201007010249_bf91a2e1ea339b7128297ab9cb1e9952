package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1749:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1751:String = "level";
      
      private var var_111:IItemListWindow;
      
      private const const_1746:String = "energy";
      
      private var var_1223:Map;
      
      private const const_1748:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1753:uint = 3355443;
      
      private var var_238:IBorderWindow;
      
      private const const_1747:int = 158;
      
      private const const_1750:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_189:PetCommandTool;
      
      private const const_1752:uint = 11184810;
      
      private const const_1745:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_238 != null)
         {
            var_111 = var_238.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_111 == null || var_238 == null || var_65 == null)
         {
            return;
         }
         ...
         var_238.height = NaN;
         _window.width = Math.max(var_238.width,var_65.width);
      ...
      private function openTrainView() : void
      {
         if(var_189 == null)
         {
            var_189 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1223.getValue(var_609) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_189.showWindow(true);
            var_189.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1751,param1.level,param1.levelMax);
         updateStateElement(const_1745,param1.experience,param1.experienceMax);
         updateStateElement(const_1746,param1.energy,param1.energyMax);
         updateStateElement(const_1748,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_609 = param1.id;
         var_1223.remove(param1.id);
         var_1223.add(param1.id,param1);
         if(var_189 && var_189.isVisible() && param1.isOwnPet)
         {
            var_189.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_189.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_189 && var_189.getPetId() == var_609)
               {
                  var_189.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_503,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1747,const_1750,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1752);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1753);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1749);
         return _loc5_;
      }
