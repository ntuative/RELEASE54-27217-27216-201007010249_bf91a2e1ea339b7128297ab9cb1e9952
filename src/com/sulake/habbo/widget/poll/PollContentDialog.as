package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_777[var_1125] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_326)
         {
            ...
            var_326 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_326.center();
            var_326.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1125;
         if(var_1125 < var_777.length)
         {
            _loc1_ = var_777[var_1125] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_777.length);
                  _loc2_.text = _loc6_;
               }
