package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1157:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_166.state = RoomChatHistoryPulldown.const_209;
         ...
         var_46 = param2.createWindow("chatscroller","",HabboWindowType.const_1031,HabboWindowStyle.const_34,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_329 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_250 > 0 && param2)
         {
            if(var_1373)
            {
               if(Math.abs(param1 - var_250) <= const_1042)
               {
                  return;
               }
               var_1373 = false;
            ...
            if(var_329)
            {
               ...
               _loc5_ = (param1 - var_250) / 0;
               _loc3_ = var_383 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - var_250;
               _loc7_ = true;
               _loc8_ = true;
               if(var_46.scrollV < 1 - const_1157 / var_46.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1642)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_329 && !var_1281)
         {
            ...
            var_166.state = RoomChatHistoryPulldown.const_322;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_166.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_209);
      }
