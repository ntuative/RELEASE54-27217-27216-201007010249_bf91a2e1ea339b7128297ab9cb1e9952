package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_522:int = 6;
      
      private static const const_369:int = 10;
      
      private static const const_1177:Number = 18;
      
      private static const const_1489:Number = 10;
      
      private static const const_1488:Number = 8;
      ...
      private var var_216:BitmapData;
      ...
      {
         _widget.onItemMouseOut(var_1158,var_1157,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1158,var_810,var_1157,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1414 = param1.chatType;
         var_1158 = param1.userId;
         var_810 = param1.userName;
         var_1157 = param1.userCategory;
         _message = param1.text;
         var_1415 = param1.userX;
         var_216 = param1.userImage;
         var_1159 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(var_216 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_216.height);
         }
         ...
         if(var_216 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_216.width;
               _loc28_.height = var_216.height;
               _loc28_.bitmap = new BitmapData(var_216.width,var_216.height,true,0);
               _loc28_.bitmap.copyPixels(var_216,var_216.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_457 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_216.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_1159 != 0)
            {
               _loc30_ = uint(var_1159 >> 16 & 255);
               _loc31_ = uint(var_1159 >> 8 & 255);
               _loc32_ = uint(var_1159 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_369;
            }
            else
            {
               _loc19_.text = var_810 + ":";
               _loc19_.y += var_457;
               _loc19_.width = _loc19_.textWidth + const_369;
               _width += _loc19_.textWidth + const_369;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1414 == RoomWidgetChatUpdateEvent.const_268)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_810);
            }
            else if(var_1414 == RoomWidgetChatUpdateEvent.const_248)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_810);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_457;
            _loc20_.width = _loc20_.textWidth + const_522;
            _width += _loc20_.textWidth + const_522;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_369 + _loc20_.textWidth + const_522;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1158,var_1157,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1158,var_1157,_roomId,_roomCategory,param1);
      }
