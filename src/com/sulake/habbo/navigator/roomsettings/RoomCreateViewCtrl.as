package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_887:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_515 = new Timer(100);
         var_515.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_41 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_1074 = new TextFieldManager(_navigator,ITextFieldWindow(var_22.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_515)
         {
            var_515.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_515.reset();
            var_515 = null;
         }
      }
      ...
      {
         var_1074.goBackToInitialState();
         var_1074.input.textBackgroundColor = 4294967295;
         var_887 = var_41[0];
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1074.getText();
      ...
      {
         var _loc1_:Boolean = var_1074.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_887.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1295 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1295 = true;
            _loc3_.y = 1;
