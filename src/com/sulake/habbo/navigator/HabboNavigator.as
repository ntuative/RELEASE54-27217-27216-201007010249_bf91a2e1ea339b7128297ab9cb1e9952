package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2542:Dictionary;
      ...
      private var var_469:Tabs;
      
      private var var_301:MainViewCtrl;
      
      private var var_2361:Array;
      
      private var var_1166:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_301 = new MainViewCtrl(this);
         var_577 = new RoomInfoViewCtrl(this);
         var_1002 = new RoomCreateViewCtrl(this);
         var_2087 = new RoomThumbnailRenderer(this);
         var_1166 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_469 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_301.startSearch(Tabs.const_230,Tabs.const_345,param1);
         var_301.mainWindow.activate();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(_toolbar != null)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         var_577.userDefinedRoomEventsCtrl.stuffSelected(param1,param2);
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_301.startSearch(Tabs.const_282,Tabs.const_203);
         var_469.getTab(Tabs.const_282).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_301.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
