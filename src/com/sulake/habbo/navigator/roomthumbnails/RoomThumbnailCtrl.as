package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2235:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1653,this._model.mode != ThumbnailEditorModel.const_50);
         setEnabled(var_1654,this._model.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1653 = IButtonWindow(find("top_tab"));
         var_1654 = IButtonWindow(find("obj_tab"));
         var_2235 = IWindowContainer(find("tile_grid"));
         var_2236 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1653,onTopTabButton);
         Util.setProcDirectly(var_1654,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2235;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_2236;
