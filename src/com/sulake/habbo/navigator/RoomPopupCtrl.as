package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_2087:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_2087 = new RoomThumbnailRenderer(param1);
         var_917 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_188,var_121.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_188.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_188.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_917.refreshTags(_loc1_,var_121.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_2087.refreshThumbnail(_loc1_,var_121.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_188 == null)
         {
            var_188 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_188.visible = true;
         Util.hideChildren(var_188);
         refreshRoomName(var_188,var_121);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_188,!true ? getEventCtg(var_121.categoryId) : getRoomCtg(var_121.categoryId));
         refreshRoomDesc(var_188,var_121);
         refreshExtraCont();
         refreshInfo(var_188,"trading_allowed",var_121.allowTrading);
         refreshInfo(var_188,"doormode_doorbell",false);
         refreshInfo(var_188,"doormode_password",false);
         Util.moveChildrenToColumn(var_188,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_188.height = Util.getLowestPoint(var_188);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_230,Tabs.const_195,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
