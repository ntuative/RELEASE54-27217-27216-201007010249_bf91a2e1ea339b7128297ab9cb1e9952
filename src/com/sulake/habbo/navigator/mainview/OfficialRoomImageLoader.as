package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomImageLoader implements IDisposable
   {
      ...
      private var var_784:IBitmapWrapperWindow;
      ...
      public function startLoad() : void
      {
         ...
         else
         {
            ...
            _loc2_.addEventListener(AssetLoaderEvent.const_41,onLoadError);
         }
      }
      ...
      private function setImage() : void
      {
         ...
         var_784.bitmap = _loc1_;
         var_784.width = _loc1_.width;
         var_784.height = _loc1_.height;
