package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_559:IDropMenuWindow;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 3)
         {
            return Tabs.const_700;
         }
         if(param1 == 4)
         {
            return Tabs.const_647;
         }
         return Tabs.const_203;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_559 == null ? 0 : int(var_559.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_282,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_559 == null)
         {
            var_559 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_559.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
