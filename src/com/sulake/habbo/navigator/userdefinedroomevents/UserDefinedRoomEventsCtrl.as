package com.sulake.habbo.navigator.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1549:int = 16;
       
      
      private var var_84:int = 1;
      
      private const const_364:int = 1;
      
      private const const_777:int = 4;
      
      private var var_502:IWindowContainer;
      
      private var _window:IWindowContainer;
      
      private const const_1088:int = 3;
      ...
      private var var_1058:ActionTypes;
      ...
      private var var_1060:IWindowContainer;
      
      private var var_202:ActionType;
      
      private var var_501:IWindowContainer;
      
      private var var_725:IWindowContainer;
      
      private var var_201:TriggerConf;
      
      private const const_1465:int = 2;
      
      private var var_723:IWindowContainer;
      
      private var _navigator:HabboNavigator;
      
      private const const_1464:int = 6;
      
      private var var_1059:TriggerConfs;
      
      private var var_1280:IWindowContainer;
      
      private const const_778:int = 7;
      ...
      {
         var_1059 = new TriggerConfs();
         super();
         _navigator = param1;
         var_1058 = new ActionTypes(param1);
      }
      ...
      private function refreshAction(param1:IWindowContainer, param2:int, param3:ActionDefinition) : void
      {
         ...
         _loc4_.y = param2 * var_1549;
      }
      
      private function isStuffSelectionMode() : Boolean
      {
         return this.var_84 == const_1088 || this.var_84 == const_1464;
      }
      ...
      private function refreshSelectFurni() : void
      {
         ...
         {
            this.var_1060.visible = false;
            return;
         }
         this.var_1060.visible = true;
         var _loc1_:IWindow = this.var_1060.findChildByName("furni_name_txt");
         var _loc2_:IButtonWindow = IButtonWindow(this.var_1060.findChildByName("select_furni_button"));
         if(var_310 > 0)
         {
            _loc2_.enable();
            _loc1_.caption = var_1279 + " (" + var_310 + ")";
            _loc1_.visible = true;
         }
         else
         {
      ...
      private function onSelectFurni(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_84 = var_84 == const_1088 ? int(const_777) : int(const_778);
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_503.getChildByName("" + param1));
         if(_loc3_ == null)
         {
            _loc3_ = IWindowContainer(_navigator.getXmlWindow("ude_event"));
            _loc3_.name = "" + param1;
            var_503.addChild(_loc3_);
      ...
      {
         var _loc3_:TriggerConf = var_1059.getByCode(param2.triggerConf);
      ...
      private function onSelectActionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_202 = this.var_1058.getByCode(_loc3_);
         Logger.log("Found action type: undefined, undefined, undefined");
         var_84 = !true ? int(const_1464) : int(const_778);
         this.prepareForConfigure();
      }
      ...
      private function refreshSelectActionType() : void
      {
         ...
         var _loc1_:IWindowContainer = IWindowContainer(var_725.findChildByName("action_types_container"));
         if(_loc1_.numChildren < 1)
         {
            _loc3_ = 25;
            _loc4_ = 0;
            while(_loc4_ < this.var_1058.types.length)
            {
               _loc5_ = this.var_1058.types[_loc4_];
         ...
         var_725.getChildByName("cancel_add_action_button").y = _loc2_;
         var_725.height = Util.getLowestPoint(var_725);
      }
      ...
      {
         if(var_84 == const_777 && true)
         {
            addTrigger();
         }
         else if(var_84 == const_778 && true)
         {
            addAction();
         }
         else
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_502.findChildByName("custom_inputs_container"));
         ...
         this._navigator.send(new AddActionMessageComposer(var_724,var_202.code,var_310,var_310 > 0 ? var_1279 : "",_loc3_));
         this.var_84 = const_364;
      }
      ...
      private function onSelectTriggerConf(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_201 = this.var_1059.getByCode(_loc3_);
         Logger.log("Found trigger conf: undefined, undefined, undefined");
         var_84 = !true ? int(const_1088) : int(const_777);
         this.prepareForConfigure();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1871 = IButtonWindow(find("add_event_button"));
         var_1872 = IButtonWindow(find("back_button"));
         var_1873 = IButtonWindow(find("reload_button"));
         var_503 = IWindowContainer(find("events_container"));
         var_723 = IWindowContainer(find("select_trigger_type_container"));
         var_501 = IWindowContainer(find("configure_trigger_container"));
         var_725 = IWindowContainer(find("select_action_type_container"));
         var_502 = IWindowContainer(find("configure_action_container"));
         var_1060 = IWindowContainer(find("select_furni_container"));
         var_1280 = IWindowContainer(find("footer_container"));
         Util.setProcDirectly(var_1871,onAddEventButton);
         Util.setProcDirectly(var_1872,onBackButton);
         Util.setProcDirectly(var_1873,onReloadButton);
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         if(var_84 == const_364)
         {
            var_1280.y = Util.getLowestPoint(this._window);
      ...
      private function refreshConfigureAction() : void
      {
         ...
         if(false)
         {
            ...
            var_202.onEditStart(_loc3_,var_310);
            _loc3_.visible = true;
         }
         _loc1_.height = Util.getLowestPoint(_loc1_);
         var _loc2_:int = _loc1_.height + _loc1_.y;
         var_502.getChildByName("save_action_button").y = _loc2_;
         var_502.getChildByName("cancel_save_action_button").y = _loc2_;
         var_502.height = Util.getLowestPoint(var_502) + 1;
      }
      ...
      private function refreshSelectTriggerType() : void
      {
         ...
         var _loc1_:IWindowContainer = IWindowContainer(var_723.findChildByName("trigger_types_container"));
         if(_loc1_.numChildren < 1)
         {
            _loc3_ = 25;
            _loc4_ = 0;
            while(_loc4_ < this.var_1059.confs.length)
            {
               _loc5_ = this.var_1059.confs[_loc4_];
         ...
         _loc1_.height = Util.getLowestPoint(_loc1_);
         var _loc2_:int = _loc1_.height + _loc1_.y + 5;
         var_723.getChildByName("cancel_add_trigger_button").y = _loc2_;
         var_723.height = Util.getLowestPoint(var_723);
      }
      ...
      private function refreshEvents() : void
      {
         ...
         Util.hideChildren(this.var_503);
         ...
         Util.moveAllChildrenToColumn(this.var_503,0,0);
         this.var_503.height = Util.getLowestPoint(this.var_503);
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_501.findChildByName("custom_inputs_container"));
         var _loc2_:IWindowContainer = IWindowContainer(_loc1_.getChildByName("undefined"));
         var _loc3_:String = var_201.readParamsFromForm(_loc2_);
         this._navigator.send(new AddTriggerMessageComposer(var_724,var_201.code,var_310,var_310 > 0 ? var_1279 : "",_loc3_));
         this.var_84 = const_364;
      }
      ...
      private function onAddTriggerButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_310 = 0;
         var_724 = param2.parent.id;
         Logger.log("add trigger clicked: " + var_724);
      ...
      private function refreshConfigureTrigger() : void
      {
         ...
         if(var_84 != const_777)
         {
            this.var_501.visible = false;
            return;
         }
         this.var_501.visible = true;
         var _loc1_:IWindowContainer = IWindowContainer(var_501.findChildByName("custom_inputs_container"));
         Util.hideChildren(_loc1_);
         if(false)
         {
         ...
         _loc1_.height = Util.getLowestPoint(_loc1_);
         var _loc2_:int = _loc1_.height + _loc1_.y;
         var_501.getChildByName("save_trigger_button").y = _loc2_;
         var_501.getChildByName("cancel_save_trigger_button").y = _loc2_;
         var_501.height = Util.getLowestPoint(var_501) + 1;
      }
      ...
      private function onAddActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_310 = 0;
         var_724 = param2.parent.id;
         Logger.log("add action clicked: " + var_724);
      ...
      {
         var _loc3_:ActionType = var_1058.getByCode(param2.type);
         param1.findChildByName("desc_txt").caption = _loc3_.getDesc(param2);
      }
