package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1287 || var_1530 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1531 == 0 || _loc1_ - var_1531 > var_1530)
         {
            if(_connection != null)
            {
      ...
      {
         var_1287 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1530 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
