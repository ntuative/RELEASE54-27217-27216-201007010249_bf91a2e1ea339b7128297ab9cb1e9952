package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_830:uint = 11;
      ...
      private var var_579:FramerateTracker = null;
      ...
      private var var_1006:LagWarningLogger = null;
      
      private var var_1005:IHabboWindowManager;
      ...
      private var var_193:IHabboFriendList;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_258 = new PerformanceTracker();
         var_579 = new FramerateTracker();
         var_259 = new LatencyTracker();
         var_1006 = new LagWarningLogger();
         var_1463 = new Array(const_830);
         var _loc4_:int = 0;
         while(_loc4_ < const_830)
         {
            var_1463[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1329,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_646,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_838,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1262);
               break;
            case HabboCommunicationEvent.const_551:
               trackLoginStep(HabboLoginTrackingStep.const_1196,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_234:
               trackLoginStep(HabboLoginTrackingStep.const_234);
               break;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_258 != null)
            {
               var_258.connection = param1;
            }
            if(var_259 != null)
            {
               var_259.communication = _communication;
               var_259.connection = param1;
            }
            if(var_1006 != null)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_150)
         {
            Component(var_150).events.addEventListener(HabboConfigurationEvent.const_155,onConfigurationLoaded);
            if(var_259 != null)
            {
               var_259.configuration = var_150;
            }
            if(var_258 != null)
            {
               var_258.configuration = var_150;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_296.events.addEventListener(AdEvent.const_377,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_2364)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1351);
            var_2364 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_838,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_646,String(true));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_1005)
            {
               var_1005.release(new IIDHabboWindowManager());
               var_1005 = null;
            }
            if(var_296)
            {
            ...
            if(var_193)
            {
               if(true)
               {
                  Component(var_193).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_193).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_193).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_193).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_193).events.removeEventListener(HabboFriendListTrackingEvent.const_339,onFriendlistTrackingEvent);
               }
               var_193.release(new IIDHabboFriendList());
               var_193 = null;
            }
            if(var_165)
            {
               if(true)
               {
                  var_165.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_165.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_165.release(new IIDHabboHelp());
               var_165 = null;
            }
            if(_roomEngine)
            {
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_551,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_234,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_547,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_58,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_495,onHotelViewEvent);
      }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_150)
         {
            if(var_1006 != null)
            {
               var_1006.configure(var_150);
            }
            if(var_579 != null)
            {
               var_579.configure(var_150);
            }
            Component(var_150).events.removeEventListener(HabboConfigurationEvent.const_155,onConfigurationLoaded);
         }
      }
      ...
      {
         var_165 = param2 as IHabboHelp;
         var_165.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_165.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_947,onCoreRunning);
         }
      }
      ...
      {
         var_1005 = IHabboWindowManager(param2);
         if(var_1005)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1183 > -1 && _loc2_ < var_1183)
         {
            ++var_1709;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1709);
         }
         if(var_1183 > -1 && _loc2_ - var_1183 > 15000)
         {
            ++var_1708;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1708);
         }
         var_1183 = _loc2_;
         if(var_258 != null)
         {
            var_258.update(param1);
         }
         if(var_259 != null)
         {
            var_259.update(param1);
         }
         if(var_579 != null)
         {
            var_579.trackUpdate(param1,this);
         }
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_281,onRoomAdClick);
      }
      ...
      {
         var_193 = param2 as IHabboFriendList;
         Component(var_193).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_193).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_193).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_193).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_193).events.addEventListener(HabboFriendListTrackingEvent.const_339,onFriendlistTrackingEvent);
      }
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_150)
            {
               if(var_150.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(var_258 != null)
                  {
                     _loc4_["null"] = var_258.flashVersion;
                     _loc4_["null"] = var_258.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_547)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1232);
         }
         else if(param1.type == HabboHotelViewEvent.const_495)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1224);
         }
         else if(param1.type == HabboHotelViewEvent.const_58)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1216);
         }
      }
   }
}
