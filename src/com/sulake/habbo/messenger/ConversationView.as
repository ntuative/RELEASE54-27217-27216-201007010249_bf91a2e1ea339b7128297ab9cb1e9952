package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1175:int = 10;
      
      private static const const_1176:int = 20;
      
      private static const const_825:int = 100;
       
      
      private var var_2301:IScrollbarWindow;
      
      private var var_133:HabboMessenger;
      
      private var var_1678:IContainerButtonWindow;
      
      private var var_557:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_133 = param1;
         var_1678 = initButton("follow_friend",onFollowButtonClick,param2);
         var_52 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2301 = IScrollbarWindow(param2.findChildByName("scroller"));
         var_133.refreshButton(param2,"close",true,onCloseButtonClick,0);
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(var_133.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_751 || param3.type == Message.const_696 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_557.messages.length - const_825);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_557.messages.length)
         {
            refreshEntry(true,_loc1_,var_557.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_557 == null || _loc1_.id != var_557.id)
         {
            var_557 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_825 + const_1176)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_133.conversations.closeConversation();
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_133.send(new FollowFriendMessageComposer(var_557.id));
      }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = var_133.getButtonImage(param1);
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(var_133.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            var_133.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1175;
         param1.invalidate();
      }
   }
}
