package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private const const_1728:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private var var_1501:BitmapData;
      
      private var var_404:Rectangle;
      
      private var _isDisposed:Boolean;
      
      private const const_1727:int = 13421772;
      ...
      private var var_595:IFigurePartSet;
      
      private var var_1499:int = 0;
      
      private var var_403:IAvatarRenderManager;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            var_398 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               var_1499 = Math.max(var_1499,_loc6_.colorLayerIndex);
            }
         }
         var_403 = _model.controller.avatarRenderManager;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(var_404 == null)
         {
            if(!analyzePartLayers())
            {
               if(!var_1501)
               {
                  ...
                  var_1501 = _loc9_.content as BitmapData;
               }
               return var_1501;
            }
         }
         ...
         _loc1_ = new BitmapData(var_404.width,var_404.height,true,16777215);
         var _loc6_:int = 0;
         ...
         for each(_loc2_ in _loc8_)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + const_246[_loc6_] + "_" + FigureData.const_110;
               _loc4_ = var_403.getAssetByName(_loc3_) as BitmapDataAsset;
            }
            else
            {
               _loc6_ = 0;
            ...
            if(_loc4_)
            {
               ...
               if(var_1500 && _loc2_.colorLayerIndex > 0)
               {
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(isSelected)
         {
            _window.color = const_1727;
         }
         else
         {
            _window.color = const_1728;
         }
         _window.invalidate();
      }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         var _loc1_:AvatarFigureContainer = var_403.createFigureContainer("undefined-undefined");
         Logger.log("QUERYING SET:undefined-undefined");
         if(!var_403.isFigureReady(_loc1_))
         {
            var_403.downloadFigure(_loc1_,this);
            return false;
         }
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
