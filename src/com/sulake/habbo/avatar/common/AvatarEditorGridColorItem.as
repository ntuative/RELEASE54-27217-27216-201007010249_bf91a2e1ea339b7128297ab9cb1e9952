package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_758:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         var_711 = _loc4_.content as BitmapData;
         ...
         var_759 = _loc6_.content as BitmapData;
         updateThumbData();
      }
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_711.width,var_711.height,true,0);
            _loc1_.bitmap.copyPixels(var_711,var_711.rect,new Point(0,0));
         }
         ...
         if(_loc2_ != null)
         {
            ...
            _loc5_.colorTransform(_loc5_.rect,var_758.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_759.width,var_759.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_759,var_759.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
