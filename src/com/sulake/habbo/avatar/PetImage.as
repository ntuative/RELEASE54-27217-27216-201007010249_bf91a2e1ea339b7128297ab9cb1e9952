package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         var_444 = new AvatarFigureContainer(param3);
         var _loc5_:int = var_444.getPartSetId("pbd");
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_40)
         {
            ...
            _loc3_ = var_82.renderManager.petDataManager.getPetData(var_1304);
            if(_loc3_ != null)
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               _loc16_ = var_82.getParts(_loc9_,var_444,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(var_531);
                  _loc21_ = var_95;
                  _loc22_ = 1;
                  switch(var_95)
                  {
                  ...
                  if(_loc23_ != null)
                  {
                     ...
                     _loc12_.y += _loc23_.y;
                     if(var_95 == 7 && _loc13_.getDirection() == 6)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(var_95 == 4 && _loc13_.getDirection() == 3)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                     else if(var_95 == 3 && _loc13_.getDirection() == 4)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(var_95 == 6 && _loc13_.getDirection() == 7)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                  }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,var_531);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = var_82.getParts(_loc8_,var_444,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = var_1304 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(var_531);
                  _loc20_ = var_95;
                  _loc21_ = 1;
                  switch(var_95)
                  {
