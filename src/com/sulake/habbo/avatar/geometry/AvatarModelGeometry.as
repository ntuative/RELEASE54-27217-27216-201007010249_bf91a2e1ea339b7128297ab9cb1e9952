package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1529:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var_1529 = new AvatarSet(param1.avatarset[0]);
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            var_709[String(_loc6_.@id)] = _loc7_;
         }
      }
      ...
      {
         var _loc2_:AvatarSet = var_1529.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1529.findAvatarSet(param1);
         if(_loc3_ != null)
         {
