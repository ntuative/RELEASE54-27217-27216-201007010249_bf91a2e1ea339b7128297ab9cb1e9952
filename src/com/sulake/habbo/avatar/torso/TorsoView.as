   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(_model,FigureData.const_224,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(_model && var_155 == "")
         {
            _model.switchCategory(FigureData.const_181);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "tab_accessories":
                  ...
                  break;
               case "tab_prints":
                  switchCategory(FigureData.const_224);
            }
         }
