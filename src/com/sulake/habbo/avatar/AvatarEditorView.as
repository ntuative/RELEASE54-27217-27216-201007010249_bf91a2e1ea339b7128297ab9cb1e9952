package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_2411:int = 6710886;
      ...
      private var var_517:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         var_1078 = [];
         var_1130 = [AvatarEditorFigureCategory.const_745,AvatarEditorFigureCategory.const_40,AvatarEditorFigureCategory.const_229,AvatarEditorFigureCategory.const_593,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_90];
         super();
         _controller = param1;
      ...
      public function update() : void
      {
         ...
         if(_controller.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1572 == AvatarEditorSideCategory.const_90 || var_1955))
         {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         var_517 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = -1;
         while(_loc2_ >= 0)
         {
            _loc4_ = var_517.getSelectableAt(_loc2_);
            if(_loc4_ != null && var_1078.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = var_517.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < var_517.numSelectables)
               {
                  var_517.getSelectableAt(_loc6_).x = var_517.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return validateAvailableCategories(var_1130);
         }
         if(param1.length != var_1078.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(var_1078.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_608:
               break;
            case AvatarEditorSideCategory.const_394:
               _loc3_ = _controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_394);
               break;
      ...
      {
         if(var_1572 == AvatarEditorSideCategory.const_90)
         {
            var_1955 = false;
            setSideContent(AvatarEditorSideCategory.const_608);
         }
         else
         {
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_294 = param1;
         var_517.setSelected(var_517.getSelectableByName(param1));
         _window.invalidate();
      }
