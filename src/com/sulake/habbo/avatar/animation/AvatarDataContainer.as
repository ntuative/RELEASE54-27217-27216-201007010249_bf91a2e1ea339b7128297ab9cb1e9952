package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2147:uint;
      
      private var _rgb:uint;
      
      private var var_1133:Map;
      
      private var var_1545:Number = 1.0;
      
      private var _b:uint;
      
      private var var_1547:Number = 1.0;
      ...
      private var var_1546:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1546,var_1547,var_1545,_alphaMultiplier);
         var_1133 = generatePaletteMapForGrayscale(var_2146,var_2147);
      }
      
      public function get reds() : Array
      {
         return var_1133.getValue("reds") as Array;
      }
      ...
      {
         return var_1133.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1133.getValue("greens") as Array;
      }
      ...
      {
         return var_1133.getValue("alphas") as Array;
      }
