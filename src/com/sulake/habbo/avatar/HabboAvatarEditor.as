package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1112:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1114:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
       
      
      private var _view:AvatarEditorView;
      
      private var var_883:AvatarEditorHandler;
      ...
      private const const_1113:int = 2;
      ...
      private var var_1073:IHabboAvatarEditorDataSaver = null;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_736.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_172)
         {
            ...
            var_514["null"] = new FigureData(this);
            var_514["null"] = new FigureData(this);
            _loc1_ = var_514["null"];
            _loc2_ = var_514["null"];
            _loc1_.loadAvatarData(const_1112,FigureData.const_67);
            _loc2_.loadAvatarData(const_1114,FigureData.FEMALE);
            var_94 = new Map();
            var_419 = new Map();
            var_94.add(AvatarEditorFigureCategory.const_745,new BodyModel(this));
            var_94.add(AvatarEditorFigureCategory.const_40,new HeadModel(this));
            var_94.add(AvatarEditorFigureCategory.const_229,new TorsoModel(this));
            var_94.add(AvatarEditorFigureCategory.const_593,new LegsModel(this));
            var_94.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            var_419.add(AvatarEditorSideCategory.const_90,new WardrobeModel(this));
            var_419.add(AvatarEditorSideCategory.const_394,new ClubPromoModel(this));
            var_172 = true;
         }
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(var_1073 != null)
         {
            ...
            _loc2_ = "null";
            var_1073.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1072 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = isClubTryoutAllowed() && var_1565;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || var_1072 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_1113)
                  {
            ...
            {
               _loc20_ = 2;
               _loc14_ = var_418.getMandatoryAvatarPartSetIds(gender,_loc20_);
            }
            else
            {
               _loc14_ = var_418.getMandatoryAvatarPartSetIds(gender,clubMemberLevel);
            }
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1213)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || var_1072 >= _loc6_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_419.getValue(AvatarEditorSideCategory.const_90);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_883 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_736.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false) : Boolean
      {
         ...
         else
         {
            if(var_235 == null)
            {
               var_235 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_52,HabboWindowStyle.const_36,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            toggleAvatarEditorPage(AvatarEditorFigureCategory.const_745);
         }
         var_1073 = param2;
         return true;
      }
      ...
      {
         var_736 = var_418.getFigureData(AvatarType.const_70);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_418 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1072 = param3;
         var _loc4_:FigureData = var_514[param2];
         if(_loc4_ == null)
         {
            return;
         }
