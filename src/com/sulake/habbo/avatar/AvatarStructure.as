package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_466:PartSetsData;
      
      private var var_1695:PartOffsetData;
      
      private var var_994:AvatarActionManager;
      
      private var var_192:IAssetLibrary;
      
      private var var_993:IAssetLibrary;
      
      private var var_403:AvatarRenderManager;
      
      private var var_337:FigureData;
      
      private var var_631:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_679:String;
      
      private var var_1694:AvatarStructureDownloadSet;
      
      private var var_821:Dictionary;
      
      private var var_822:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_192 = param2;
         var_993 = param3;
         var_337 = new FigureData();
         var_466 = new PartSetsData();
         var_631 = new AnimationData();
         var_1694 = new AvatarStructureDownloadSet();
         var_822 = new AnimationManager();
         var_679 = param4;
         var_1695 = PartOffsetData.getInstance(param3);
      ...
      {
         return var_994.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_994.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_337.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_994.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_822.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_466.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_466.getActiveParts(param1.definition);
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_994.getDefaultAction();
         var _loc9_:Array = var_466.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_822.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_337.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_337.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_631.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_466.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_466.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_679 + " ready to go!");
         if(var_679 == AvatarType.const_70)
         {
            var_466.getPartDefinition("ri").appendToFigure = true;
            var_466.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_679)
         {
            case AvatarType.const_70:
               ...
               var_1694.add(new AvatarStructureDownload(var_192,_loc5_,var_337));
               break;
            case AvatarType.PET:
         }
         var_1694.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_822.getAnimation(param1);
      }
      ...
      {
         var_994 = new AvatarActionManager(var_192,var_679);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(true)
         {
            var_821[param1] = new Dictionary();
         }
         if(var_821[param1][param2])
         {
            return var_821[param1][param2];
         }
         var_821[param1][param2] = var_337.getMandatorySetTypeIds(param1,param2);
         return var_821[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_337.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_993.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_993.getAssetByName("dance" + _loc1_).content as XML;
            var_822.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_993.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_993.getAssetByName("fx" + _loc1_).content as XML;
            var_822.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_337.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_337.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1695.loadOffsets(var_993);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_994.sortActions(param1);
      }
   }
}
