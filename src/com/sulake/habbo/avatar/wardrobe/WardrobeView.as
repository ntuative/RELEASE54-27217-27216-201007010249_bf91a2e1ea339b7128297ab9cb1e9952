package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_744:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_744 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1088 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_744)
         {
            var_744.removeListItems();
         }
         if(var_1088)
         {
            var_1088.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_744)
               {
                  var_744.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1088)
            {
               var_1088.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
