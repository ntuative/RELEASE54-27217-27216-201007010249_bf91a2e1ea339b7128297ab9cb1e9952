package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1762 = param2;
         var_361 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_136,onBadgeImageReady);
         ...
         var_204 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_2368 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_204);
      ...
      public function dispose() : void
      {
         if(var_361 != null)
         {
            var_361.events.removeEventListener(BadgeImageReadyEvent.const_136,onBadgeImageReady);
            var_361 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_829,var_2368);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_829,var_829));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_829,var_829));
         _localizations.registerParameter(param1,"level",var_1762.toString());
         _localizations.registerParameter(param1,"name",var_361.userName);
         _localizations.registerParameter(param1,"realname",var_361.realName);
      }
   }
}
