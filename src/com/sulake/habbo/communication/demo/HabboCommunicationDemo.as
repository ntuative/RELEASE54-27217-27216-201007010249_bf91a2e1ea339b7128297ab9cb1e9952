package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1792:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1516:ILogger;
      
      private var var_1245:String;
      
      private var var_1793:String;
      
      private const const_1461:String = "fuselogin";
      
      private var var_320:ICoreCommunicationManager;
      
      private var var_408:IKeyExchange;
      ...
      private var var_60:IHabboCommunicationManager;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1794)
         {
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         var_1044 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_234);
         connection.send(new VersionCheckMessageComposer(401,var_1245,var_1793));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(const_1461,"/");
      ...
      {
         var _loc4_:IConnection = var_60.getHabboMainConnection(null);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_408.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_408.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1792);
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1245 = _habboConfiguration.getKey("flash.client.url","");
         var_1793 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_176 == null)
         {
         ...
         if(var_706 != null)
         {
            var_60.mode = HabboConnectionType.const_392;
            var_60.initConnection(HabboConnectionType.const_250);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1516 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_60 = param2 as IHabboCommunicationManager;
            _loc3_ = var_60.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_60.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_60.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_60.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_60.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_60.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_60.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_60.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_60.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_60.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_60.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_60.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_60.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
            var_60.addHabboConnectionMessageEvent(new IdentityAccountsEvent(onIdentityAccounts));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_60.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_551);
            _loc3_ = new InitCryptoMessageComposer(var_60.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1792 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_60.mode)
         {
            case HabboConnectionType.const_392:
               ...
               var_1043 = _loc4_;
               var_176.loadBannerImage(_loc7_ + "?token=" + var_1043,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_951:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1235:
               var_602 = generateRandomHexString(30);
               var_408 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_408.init(var_602);
               _loc8_ = var_408.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1043);
         ...
         var _loc9_:IConnection = var_60.getHabboMainConnection(null);
         ...
         var_408 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_408.init(_loc14_);
            _loc15_ = var_408.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_60.mode = HabboConnectionType.const_951;
            }
         }
         var_60.initConnection(HabboConnectionType.const_250);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_239);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_155,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_21.events.addEventListener(RoomSessionEvent.const_108,onRoomSessionEnded);
      }
