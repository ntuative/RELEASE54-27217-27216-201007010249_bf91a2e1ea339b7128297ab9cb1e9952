package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_686:Function;
      
      private var _window:IWindowContainer;
      
      private var var_833:IAssetLibrary;
      
      private var var_1010:uint = 0;
      
      private var var_685:Function;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_833.getAssetByName(_loc2_.assetName);
         ...
         else if(param1.type == AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_495));
            }
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_41,hotelViewLoadedCallbackHandler);
      }
      
      public function loadBannerImage(param1:String, param2:Function) : void
      {
         var _loc3_:AssetLoaderStruct = var_833.loadAssetFromFile("hotel_view_banner_" + var_1010,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,bannerLoadedHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_41,bannerLoadedHandler);
         }
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_547));
            }
            var_685 = param2;
            _loc3_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,bannerLoadedCallbackHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_41,bannerLoadedCallbackHandler);
         }
         ++var_1010;
      }
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_41,hotelViewLoadedHandler);
      }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_833.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,hotelViewLoadedHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_41,hotelViewLoadedHandler);
         }
         else
         {
            var_686 = param2;
            _loc3_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,hotelViewLoadedCallbackHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_41,hotelViewLoadedCallbackHandler);
         }
         ++var_1010;
      }
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_41,bannerLoadedCallbackHandler);
      }
      ...
      private function bannerLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_41,bannerLoadedHandler);
      }
