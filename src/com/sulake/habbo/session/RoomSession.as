package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1184:UserDataManager;
      ...
      public function start() : Boolean
      {
         ...
         {
            var_38 = RoomSessionEvent.const_89;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1184 as IUserDataManager;
      }
