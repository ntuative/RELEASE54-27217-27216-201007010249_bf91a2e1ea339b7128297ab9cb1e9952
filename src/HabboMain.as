package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_769:Number = 0.71;
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_769 + var_30.getNumberOfFilesLoaded() / _loc11_ * const_769;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
      ...
      private function prepareCore() : void
      {
         ...
         else
         {
            ...
            _loc1_.addEventListener(AssetLoaderEvent.const_41,configLoadedHandler);
         }
      }
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_41,configLoadedHandler);
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_869,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_21);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_869,error);
            Core.dispose();
         }
      }
