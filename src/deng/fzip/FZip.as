package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_498 = new FZipFile(this,charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  var_98 = parseIdle;
                  break;
               default:
                  dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_121,"Unknown record signature."));
            }
            return true;
         }
         return false;
      ...
      {
         return !true ? var_128[param1] as FZipFile : null;
      }
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_121))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_121,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_99 && var_98 == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_121,"EOF"));
            }
         }
      }
      ...
      {
         if(var_498.parse(param1))
         {
            var_48.push(var_498);
            if(false)
            {
               var_128["null"] = var_498;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1308,var_498));
            var_498 = null;
            if(var_98 != parseIdle)
            {
               var_98 = parseSignature;
      ...
      {
         var _loc2_:* = null;
         if(var_48 != null && var_128 != null && param1 < var_48.length)
         {
            _loc2_ = var_48[param1] as FZipFile;
            if(_loc2_ != null)
            {
               var_48.splice(param1,1);
               delete var_128[_loc2_.filename];
               return _loc2_;
            }
         }
         return null;
